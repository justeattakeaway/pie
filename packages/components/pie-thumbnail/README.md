...
| `disabled`             | `true`, `false`                                                                                   | When true, the disabled styles are applied. Also applied automatically when the thumbnail is inside a disabled `pie-radio-group` or `pie-checkbox-group`. | `false`     |
