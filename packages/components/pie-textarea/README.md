...
|----------------|--------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| `aria`         | `{ label?: string }`                                         | ARIA attributes for the textarea. Offers `label` — use it when no visible label is associated with the textarea. `aria-invalid`, `aria-errormessage`, and `aria-describedby` are derived automatically from `status` and `assistiveText`. | `undefined` |
