...
| `defaultValue` | `string`                                                     | pre-populates the textarea on first render when `value` is not provided. Also used to restore the value when the form is reset, even if `value` is provided.                                                                                     | `undefined` |
...
| `value`        | `string`                                                     | Value of the textarea (used in form key/value pairs). When provided, the component is controlled and always reflects this value.                                                                                                                  | `undefined` |
