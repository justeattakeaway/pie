...
- [Changed] - `@validPropertyValues` and `@requiredProperty` decorators to support Lit 3. ([#1020](https://github.com/justeattakeaway/pie/pull/1020)) by [@raoufswe](https://github.com/raoufswe)
