 ...
 */
export const validPropertyValues = <T>(componentName: string, validValues: T[], defaultValue: T) => function validatePropertyValues (target: object, propertyKey: string): void {
