...
| `cookieStatementLink`   | —                                                                       | The URL of the cookie statement page the banner should link to.                                                                                                                              | `""`        |
 | `personalizedLabel`      | —                                                                       | An optional override for the personalized preference label in the "Manage preferences" modal. Supports plain text. When omitted or empty, the built-in locale string is used.                                                     | `""`      |
 | `personalizedDescription`| —                                                                       | An optional consumer override for the personalised preference description in the "Manage preferences" modal. Supports plain text or HTML `<a>` tags (e.g. `<a href="...">Privacy Policy</a>`). When omitted or empty, the built-in locale string is used. | `""`      |
