...
<p align="center">
  <a href="https://github.com/justeattakeaway/pie/tree/main/packages/components/pie-button">
  ...
  <a href="https://pie.design/components/button">
  ...
  <a href="https://www.npmjs.com/package/@justeattakeaway/pie-button">
    <img alt="npm version" src="https://img.shields.io/npm/v/@justeattakeaway/pie-button?style=for-the-badge&color=ff8000&logo=npm&logoColor=white&label=npm">
  </a>
  <a href="https://github.com/justeattakeaway/pie/blob/main/LICENSE">
    <img alt="license" src="https://img.shields.io/npm/l/@justeattakeaway/pie-button?style=for-the-badge">
  </a>
</p>
...
| `variant`        | `"primary"`, `"primary-alternative"`, `"primary-alternative-dark"`, `"secondary"`, `"outline"`, `"outline-inverse"`, `"ghost"`, `"inverse"`, `"ghost-inverse"`, `"destructive"`, `"destructive-ghost"` | Sets the variant of the button.                                                                                                                                                                                     | `"primary"`    |
