...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| `aria`           | `{ label?: string }`                                                                                                                                                     | Sets ARIA attributes on the rendered button or anchor element.                                                                                                                                                      | `undefined`    |
...
| `variant`        | `"primary"`, `"primary-alternative"`, `"primary-alternative-dark"`, `"secondary"`, `"outline"`, `"outline-inverse"`, `"ghost"`, `"ghost-dark"`, `"inverse"`, `"ghost-inverse"`, `"ghost-inverse-light"`, `"destructive"`, `"destructive-ghost"` | Sets the variant of the button.                                                                                                                                                                                     | `"primary"`    |
