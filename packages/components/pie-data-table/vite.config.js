    ...
    build: {
        lib: {
            entry: {
                ...
                'pie-data-table-contents/index': 'src/pie-data-table-contents/index.ts',
                'pie-data-table-contents/react': 'src/pie-data-table-contents/react.ts',
                'pie-data-table-head/index': 'src/pie-data-table-head/index.ts',
                'pie-data-table-head/react': 'src/pie-data-table-head/react.ts',
                'pie-data-table-head-cell/index': 'src/pie-data-table-head-cell/index.ts',
                'pie-data-table-head-cell/react': 'src/pie-data-table-head-cell/react.ts',
