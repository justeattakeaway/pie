...
| `isDimmed`        | `true`, `false`                                                                                                                                          | When true, applies a dimmed styling to the tag. Also applied automatically when the tag is inside a disabled `pie-radio-group` or `pie-checkbox-group`.                                                        | `false`     |
