...
- [Added] - `isDimmed` is now automatically applied when the tag is inside a disabled `pie-radio-group` or `pie-checkbox-group`, via Lit context. ([#3115](https://github.com/justeattakeaway/pie/pull/3115)) by [@jamieomaguire](https://github.com/jamieomaguire)
