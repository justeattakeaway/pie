...
| ariaLabel                     | `Object` | `undefined` | An object representing the aria labels for the `close` & `back` buttons within the modal as well as the `isLoading` state labels (`aria-label` & `aria-busy`).                                                                                                                                                                                                                                                                                                                                                                                                                        |
