...
export default {
    ...
    render (h, ctx) {
        ...
        return h('svg', _mergeJSXProps([{
            ...
            class: 'c-pieIcon c-pieIcon--stampcard10',
        }, ctx.data]), [h('path', {
            attrs: {
