...
export default {
    ...
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--unitedKingdom', 'IconFlagUnitedKingdom');
        return h('svg', _mergeJSXProps([{
            ...
            attrs: {
                fill: '#D80027',
                d: 'M14.94 7.087H8.913V1.06a7.07 7.07 0 0 0-1.826 0v6.027H1.06a7.07 7.07 0 0 0 0 1.826h6.027v6.027c.606.079 1.22.079 1.826 0V8.913h6.027a7.061 7.061 0 0 0 0-1.826Z',
            },
        }), h('path', {
            attrs: {
                fill: '#D80027',
                d: 'm9.827 9.827 3.122 3.122c.143-.143.28-.293.41-.448l-2.671-2.674h-.861Zm-3.654 0-3.122 3.122c.143.143.293.28.448.41l2.674-2.671v-.861Zm0-3.654L3.051 3.051a7.02 7.02 0 0 0-.41.448l2.671 2.674h.861Zm3.654 0 3.122-3.122a7.027 7.027 0 0 0-.448-.41L9.827 5.312v.861Z',
            },
        })]);
    },
};
