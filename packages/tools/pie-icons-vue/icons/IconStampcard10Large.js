...
export default {
    name: 'IconStampcard10Large',
    props: {
        size: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--stampcard10Large', 'IconStampcard10Large');
