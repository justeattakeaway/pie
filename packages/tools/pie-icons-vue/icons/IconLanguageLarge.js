...
export default {
    name: 'IconLanguageLarge',
    props: {
        iconSize: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--languageLarge', 'IconLanguageLarge');
