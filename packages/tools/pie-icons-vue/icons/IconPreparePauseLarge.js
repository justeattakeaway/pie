...
export default {
    name: 'IconPreparePauseLarge',
    props: {
        iconSize: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--preparePauseLarge', 'IconPreparePauseLarge');
