...
export default {
    name: 'IconPaymentSofort',
    props: {
        iconSize: iconSize.regular,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--sofort', 'IconPaymentSofort');
