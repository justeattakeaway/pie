...
export default {
    ...
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--chatHeart', 'IconChatHeart');
        return h('svg', _mergeJSXProps([{
            ...
            attrs: {
                d: 'M8 9.75 5.926 7.589a1.347 1.347 0 0 1 0-1.838 1.199 1.199 0 0 1 .875-.376c.329.002.644.134.875.367L8 6.058l.324-.307a1.225 1.225 0 0 1 1.75 0 1.365 1.365 0 0 1 0 1.846L8 9.75Z',
            },
        }), h('path', {
            attrs: {
