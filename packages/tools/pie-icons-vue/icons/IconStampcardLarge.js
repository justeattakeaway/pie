...
export default {
    ...
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--stampcardLarge', 'IconStampcardLarge');
