...
export default {
    ...
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--arrowDownCircleLarge', 'IconArrowDownCircleLarge');
        return h('svg', _mergeJSXProps([{
            ...
            attrs: {
                d: 'm9.726 16.623 5.04 4.865c.328.315.772.492 1.234.492.462 0 .906-.177 1.234-.492l5.04-4.865-1.234-1.191-4.165 4.02V3.75h-1.75v15.703l-4.165-4.021-1.234 1.191Z',
            },
        })]);
    },
};
