    ...
    render (h, ctx) {
        ...
        return h('svg', _mergeJSXProps([{
            ...
            attrs: {
                'fill-rule': 'evenodd',
                'clip-rule': 'evenodd',
                d: 'M15.58 9.275a3.816 3.816 0 00-2.309 1.104l-.689-1.33a.084.084 0 00-.12-.037c-.042.026-.056.088-.032.134l.71 1.372a3.595 3.595 0 00-.923 2.36h7.57a3.593 3.593 0 00-.93-2.366l.709-1.366c.023-.046.01-.108-.032-.134a.084.084 0 00-.12.036l-.687 1.326a3.818 3.818 0 00-2.302-1.099h-.845zm-1.141 2.407c.24 0 .434-.211.434-.474v-.005c0-.263-.194-.474-.434-.474-.24.005-.434.216-.434.479s.194.474.434.474zm3.238 0c.24 0 .434-.211.434-.474v-.005c0-.263-.194-.474-.434-.474-.24.005-.434.216-.434.479s.194.474.434.474z',
                fill: '#242E30',
            },
        }), h('path', {
            attrs: {
