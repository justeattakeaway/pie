...
export default {
    name: 'IconGroceryLarge',
    props: {
        iconSize: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--groceryLarge', 'IconGroceryLarge');
