...
export default {
    ...
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--mobilePay', 'IconPaymentMobilePay');
        return h('svg', _mergeJSXProps([{
            ...
            attrs: {
                fill: '#5A78FF',
                d: 'M9.007 6.853c-.564 0-1.08.11-1.481.334V5.381a3.088 3.088 0 0 1 1.481-.334c.565 0 1.092.106 1.482.334v1.806a3.086 3.086 0 0 0-1.482-.334Z',
            },
