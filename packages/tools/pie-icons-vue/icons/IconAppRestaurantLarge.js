...
export default {
    name: 'IconAppRestaurantLarge',
    props: {
        iconSize: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--appRestaurantLarge', 'IconAppRestaurantLarge');
