...
export default {
    name: 'IconSettingsLarge',
    props: {
        iconSize: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--settingsLarge', 'IconSettingsLarge');
