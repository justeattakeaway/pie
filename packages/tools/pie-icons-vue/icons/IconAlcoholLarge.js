...
export default {
    name: 'IconAlcoholLarge',
    props: {
        size: iconSize.large,
    },
    functional: true,
    render (h, ctx) {
        ctx.data = updateContextData(ctx, 'c-pieIcon c-pieIcon--alcoholLarge', 'IconAlcoholLarge');
