...
// import strict from '../../strict/index.js'; // Importing this causes the entire test suite not to run properly
...
`;
    ...
    const baseConfig = { overrideConfig: base };
    // const strictConfig = { overrideConfig: strict };
    ...
    console.error('Uncaught error in test file', error);
}
