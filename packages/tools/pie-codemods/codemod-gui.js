...
function checkGitStatus (force) {
    ...
    if (!clean) {
        if (force) {
            ...
            console.log('Thank you for using pie-codemods!');
...
const TRANSFORMER_INQUIRER_CHOICES = [
    ...
    {
        name: 'pie-button@v2.0.0',
        value: 'pie-button@v2.0.0',
        description: 'Update to version 2.0.0 of pie-button',
    }
];
