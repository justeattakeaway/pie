...
export class IconSwitchProductLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--switchProductLarge', newVal);
    }
}
