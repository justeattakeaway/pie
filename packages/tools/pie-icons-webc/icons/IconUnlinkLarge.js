...
export class IconUnlinkLarge extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--unlinkLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--unlinkLarge', '', newVal, 'IconUnlinkLarge');
...
customElements.define('icon-unlink-large', IconUnlinkLarge);
