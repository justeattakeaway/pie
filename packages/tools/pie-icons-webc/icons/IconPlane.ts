...
const componentSelector = 'icon-plane';

export class IconPlane extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--plane';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--plane', '', this.size, 'IconPlane');
...
customElements.define(componentSelector, IconPlane);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPlane;
    }
}
