...
const componentSelector = 'icon-calendar-day';

export class IconCalendarDay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--calendarDay';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarDay', '', this.size, 'IconCalendarDay');
...
customElements.define(componentSelector, IconCalendarDay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCalendarDay;
    }
}
