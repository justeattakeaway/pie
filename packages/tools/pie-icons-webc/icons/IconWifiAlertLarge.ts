...
const componentSelector = 'icon-wifi-alert-large';

export class IconWifiAlertLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--wifiAlertLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--wifiAlertLarge', '', this.size, 'IconWifiAlertLarge');
...
customElements.define(componentSelector, IconWifiAlertLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconWifiAlertLarge;
    }
}
