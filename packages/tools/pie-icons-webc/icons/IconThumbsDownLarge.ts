...
const componentSelector = 'icon-thumbs-down-large';

export class IconThumbsDownLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--thumbsDownLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDownLarge', '', this.size, 'IconThumbsDownLarge');
...
customElements.define(componentSelector, IconThumbsDownLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconThumbsDownLarge;
    }
}
