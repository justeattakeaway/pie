...
export class IconPaymentIDeal extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--iDeal', '', null, 'IconPaymentIDeal');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--iDeal');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--iDeal', '', newVal, 'IconPaymentIDeal');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--iDeal', newVal);
    }
}
