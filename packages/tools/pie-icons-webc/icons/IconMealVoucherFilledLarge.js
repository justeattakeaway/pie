...
export class IconMealVoucherFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mealVoucherFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mealVoucherFilledLarge', '', newVal, 'IconMealVoucherFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mealVoucherFilledLarge', newVal);
    }
}

customElements.define('icon-meal-voucher-filled-large', IconMealVoucherFilledLarge);
