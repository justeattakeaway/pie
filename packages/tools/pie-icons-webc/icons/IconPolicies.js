...
export class IconPolicies extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--policies');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--policies', '', newVal, 'IconPolicies');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--policies', newVal);
    }
}

customElements.define('icon-policies', IconPolicies);
