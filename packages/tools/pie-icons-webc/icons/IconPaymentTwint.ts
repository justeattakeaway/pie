...
const componentSelector = 'icon-payment-twint';

export class IconPaymentTwint extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--twint';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--twint', '', this.size, 'IconPaymentTwint');
...
customElements.define(componentSelector, IconPaymentTwint);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentTwint;
    }
}
