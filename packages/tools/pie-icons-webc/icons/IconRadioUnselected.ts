...
const componentSelector = 'icon-radio-unselected';

export class IconRadioUnselected extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--radioUnselected';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--radioUnselected', '', this.size, 'IconRadioUnselected');
...
customElements.define(componentSelector, IconRadioUnselected);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRadioUnselected;
    }
}
