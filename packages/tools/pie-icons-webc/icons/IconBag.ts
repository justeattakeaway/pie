...
const componentSelector = 'icon-bag';

export class IconBag extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--bag';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bag', '', this.size, 'IconBag');
...
customElements.define(componentSelector, IconBag);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconBag;
    }
}
