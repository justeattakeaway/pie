...
const componentSelector = 'icon-social-android-static';

export class IconSocialAndroidStatic extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--androidStatic';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--androidStatic', '', this.size, 'IconSocialAndroidStatic');
...
customElements.define(componentSelector, IconSocialAndroidStatic);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAndroidStatic;
    }
}
