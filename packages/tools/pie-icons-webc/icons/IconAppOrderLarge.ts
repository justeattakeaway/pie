...
const componentSelector = 'icon-app-order-large';

export class IconAppOrderLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appOrderLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appOrderLarge', '', this.size, 'IconAppOrderLarge');
...
customElements.define(componentSelector, IconAppOrderLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAppOrderLarge;
    }
}
