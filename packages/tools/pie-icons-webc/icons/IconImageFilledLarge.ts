...
const componentSelector = 'icon-image-filled-large';

export class IconImageFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--imageFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--imageFilledLarge', '', this.size, 'IconImageFilledLarge');
...
customElements.define(componentSelector, IconImageFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconImageFilledLarge;
    }
}
