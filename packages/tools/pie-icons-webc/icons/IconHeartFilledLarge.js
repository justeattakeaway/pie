...
export class IconHeartFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconHeartFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconHeartFilledLarge');
...
customElements.define('icon-heart-filled-large', IconHeartFilledLarge);
