...
const componentSelector = 'icon-service-charge-large';

export class IconServiceChargeLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--serviceChargeLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--serviceChargeLarge', '', this.size, 'IconServiceChargeLarge');
...
customElements.define(componentSelector, IconServiceChargeLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconServiceChargeLarge;
    }
}
