...
const componentSelector = 'icon-play';

export class IconPlay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--play';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--play', '', this.size, 'IconPlay');
...
customElements.define(componentSelector, IconPlay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPlay;
    }
}
