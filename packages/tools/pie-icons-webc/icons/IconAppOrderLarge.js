...
export class IconAppOrderLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--appOrderLarge', '', null, 'IconAppOrderLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appOrderLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appOrderLarge', '', newVal, 'IconAppOrderLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appOrderLarge', newVal);
    }
}
