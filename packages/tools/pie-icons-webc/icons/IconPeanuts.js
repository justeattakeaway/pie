...
export class IconPeanuts extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--peanuts');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--peanuts', '', newVal, 'IconPeanuts');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--peanuts', newVal);
    }
}
