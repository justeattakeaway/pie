...
const componentSelector = 'icon-takeaway-pay-filled';

export class IconTakeawayPayFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--takeawayPayFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--takeawayPayFilled', '', this.size, 'IconTakeawayPayFilled');
...
customElements.define(componentSelector, IconTakeawayPayFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTakeawayPayFilled;
    }
}
