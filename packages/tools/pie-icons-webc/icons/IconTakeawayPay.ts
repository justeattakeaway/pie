...
const componentSelector = 'icon-takeaway-pay';

export class IconTakeawayPay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--takeawayPay';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--takeawayPay', '', this.size, 'IconTakeawayPay');
...
customElements.define(componentSelector, IconTakeawayPay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTakeawayPay;
    }
}
