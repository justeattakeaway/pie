...
const componentSelector = 'icon-eye-off-filled';

export class IconEyeOffFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--eyeOffFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--eyeOffFilled', '', this.size, 'IconEyeOffFilled');
...
customElements.define(componentSelector, IconEyeOffFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconEyeOffFilled;
    }
}
