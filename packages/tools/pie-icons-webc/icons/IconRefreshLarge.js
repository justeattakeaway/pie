...
export class IconRefreshLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconRefreshLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconRefreshLarge');
...
customElements.define('icon-refresh-large', IconRefreshLarge);
