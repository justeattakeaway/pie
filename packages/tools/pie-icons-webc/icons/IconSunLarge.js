...
export class IconSunLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sunLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sunLarge', '', newVal, 'IconSunLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sunLarge', newVal);
    }
}
