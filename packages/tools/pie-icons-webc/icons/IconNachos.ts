...
const componentSelector = 'icon-nachos';

export class IconNachos extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--nachos';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--nachos', '', this.size, 'IconNachos');
...
customElements.define(componentSelector, IconNachos);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconNachos;
    }
}
