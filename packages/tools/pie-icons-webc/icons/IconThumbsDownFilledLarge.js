...
export class IconThumbsDownFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDownFilledLarge', '', newVal, 'IconThumbsDownFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownFilledLarge', newVal);
    }
}
