...
export class IconPaymentGooglePay extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--googlePay', newVal);
    }
}
