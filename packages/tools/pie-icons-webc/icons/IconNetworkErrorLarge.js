...
export class IconNetworkErrorLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--networkErrorLarge', newVal);
    }
}
