...
const componentSelector = 'icon-social-linkedin-circle-filled';

export class IconSocialLinkedinCircleFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--linkedinCircleFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinCircleFilled', '', this.size, 'IconSocialLinkedinCircleFilled');
...
customElements.define(componentSelector, IconSocialLinkedinCircleFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialLinkedinCircleFilled;
    }
}
