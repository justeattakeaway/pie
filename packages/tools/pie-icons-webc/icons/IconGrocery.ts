...
const componentSelector = 'icon-grocery';

export class IconGrocery extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--grocery';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--grocery', '', this.size, 'IconGrocery');
...
customElements.define(componentSelector, IconGrocery);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconGrocery;
    }
}
