...
export class IconImageAddLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--imageAddLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--imageAddLarge', '', newVal, 'IconImageAddLarge');
