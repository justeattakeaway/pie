...
const componentSelector = 'icon-fire';

export class IconFire extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--fire';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--fire', '', this.size, 'IconFire');
...
customElements.define(componentSelector, IconFire);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFire;
    }
}
