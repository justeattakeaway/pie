...
export class IconSocialBloggerStaticLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bloggerStaticLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bloggerStaticLarge', '', newVal, 'IconSocialBloggerStaticLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bloggerStaticLarge', newVal);
    }
}
