...
export class IconStopwatchFilledLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stopwatchFilledLarge', newVal);
    }
}
