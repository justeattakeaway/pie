...
export class IconEuroLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--euroLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--euroLarge', '', newVal, 'IconEuroLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--euroLarge', newVal);
    }
}
