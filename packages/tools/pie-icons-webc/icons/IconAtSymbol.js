...
export class IconAtSymbol extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--atSymbol');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--atSymbol', '', newVal, 'IconAtSymbol');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--atSymbol', newVal);
    }
}

customElements.define('icon-at-symbol', IconAtSymbol);
