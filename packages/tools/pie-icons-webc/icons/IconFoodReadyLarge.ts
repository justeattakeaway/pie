...
const componentSelector = 'icon-food-ready-large';

export class IconFoodReadyLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--foodReadyLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--foodReadyLarge', '', this.size, 'IconFoodReadyLarge');
...
customElements.define(componentSelector, IconFoodReadyLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFoodReadyLarge;
    }
}
