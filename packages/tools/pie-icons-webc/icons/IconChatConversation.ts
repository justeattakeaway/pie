...
const componentSelector = 'icon-chat-conversation';

export class IconChatConversation extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--chatConversation';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--chatConversation', '', this.size, 'IconChatConversation');
...
customElements.define(componentSelector, IconChatConversation);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconChatConversation;
    }
}
