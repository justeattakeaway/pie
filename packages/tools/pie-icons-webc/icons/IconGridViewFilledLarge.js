...
export class IconGridViewFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--gridViewFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--gridViewFilledLarge', '', newVal, 'IconGridViewFilledLarge');
...
customElements.define('icon-grid-view-filled-large', IconGridViewFilledLarge);
