...
const componentSelector = 'icon-location-restaurant-large';

export class IconLocationRestaurantLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--locationRestaurantLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationRestaurantLarge', '', this.size, 'IconLocationRestaurantLarge');
...
customElements.define(componentSelector, IconLocationRestaurantLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLocationRestaurantLarge;
    }
}
