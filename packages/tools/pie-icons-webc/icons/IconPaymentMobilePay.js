...
export class IconPaymentMobilePay extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mobilePay');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mobilePay', '', newVal, 'IconPaymentMobilePay');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mobilePay', newVal);
    }
}
