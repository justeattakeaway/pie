...
export class IconHiVis extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--hiVis');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--hiVis', '', newVal, 'IconHiVis');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--hiVis', newVal);
    }
}
