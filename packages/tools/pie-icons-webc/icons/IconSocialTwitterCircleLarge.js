...
export class IconSocialTwitterCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--twitterCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--twitterCircleLarge', '', newVal, 'IconSocialTwitterCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--twitterCircleLarge', newVal);
    }
}
