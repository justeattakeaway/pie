...
export class IconSoundOnFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOnFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--soundOnFilled', '', newVal, 'IconSoundOnFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOnFilled', newVal);
    }
}
