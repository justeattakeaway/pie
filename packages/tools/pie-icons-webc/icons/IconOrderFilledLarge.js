...
export class IconOrderFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--orderFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--orderFilledLarge', '', newVal, 'IconOrderFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--orderFilledLarge', newVal);
    }
}
