...
const componentSelector = 'icon-flag-denmark';

export class IconFlagDenmark extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--denmark';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--denmark', '', this.size, 'IconFlagDenmark');
...
customElements.define(componentSelector, IconFlagDenmark);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFlagDenmark;
    }
}
