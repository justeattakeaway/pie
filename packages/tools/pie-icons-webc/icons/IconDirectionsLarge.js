...
export class IconDirectionsLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--directionsLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--directionsLarge', '', newVal, 'IconDirectionsLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--directionsLarge', newVal);
    }
}
