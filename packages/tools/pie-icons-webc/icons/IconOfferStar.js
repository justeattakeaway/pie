...
export class IconOfferStar extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--offerStar');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--offerStar', '', newVal, 'IconOfferStar');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--offerStar', newVal);
    }
}
