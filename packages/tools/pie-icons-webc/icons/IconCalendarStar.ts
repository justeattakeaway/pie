...
const componentSelector = 'icon-calendar-star';

export class IconCalendarStar extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--calendarStar';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarStar', '', this.size, 'IconCalendarStar');
...
customElements.define(componentSelector, IconCalendarStar);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCalendarStar;
    }
}
