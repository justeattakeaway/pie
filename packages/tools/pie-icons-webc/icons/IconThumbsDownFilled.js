...
export class IconThumbsDownFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDownFilled', '', newVal, 'IconThumbsDownFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownFilled', newVal);
    }
}
