...
export class IconEggsLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eggsLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--eggsLarge', '', newVal, 'IconEggsLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eggsLarge', newVal);
    }
}

customElements.define('icon-eggs-large', IconEggsLarge);
