...
export class IconSocialPinterestCircleFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pinterestCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pinterestCircleFilled', '', newVal, 'IconSocialPinterestCircleFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pinterestCircleFilled', newVal);
    }
}
