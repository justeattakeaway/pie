...
export class IconSushi extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sushi');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sushi', '', newVal, 'IconSushi');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sushi', newVal);
    }
}
