...
export class IconHandCoinsLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--handCoinsLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--handCoinsLarge', '', newVal, 'IconHandCoinsLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--handCoinsLarge', newVal);
    }
}
