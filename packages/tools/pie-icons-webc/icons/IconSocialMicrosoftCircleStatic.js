...
export class IconSocialMicrosoftCircleStatic extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--microsoftCircleStatic', '', null, 'IconSocialMicrosoftCircleStatic');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microsoftCircleStatic');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--microsoftCircleStatic', '', newVal, 'IconSocialMicrosoftCircleStatic');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microsoftCircleStatic', newVal);
    }
}
