...
const componentSelector = 'icon-taco-large';

export class IconTacoLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--tacoLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--tacoLarge', '', this.size, 'IconTacoLarge');
...
customElements.define(componentSelector, IconTacoLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTacoLarge;
    }
}
