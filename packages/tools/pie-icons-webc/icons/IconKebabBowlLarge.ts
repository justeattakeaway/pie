...
const componentSelector = 'icon-kebab-bowl-large';

export class IconKebabBowlLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--kebabBowlLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--kebabBowlLarge', '', this.size, 'IconKebabBowlLarge');
...
customElements.define(componentSelector, IconKebabBowlLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconKebabBowlLarge;
    }
}
