...
export class IconMealVoucherFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mealVoucherFilled', newVal);
    }
}
