...
export class IconAtSymbolLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--atSymbolLarge', '', null, 'IconAtSymbolLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--atSymbolLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--atSymbolLarge', '', newVal, 'IconAtSymbolLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--atSymbolLarge', newVal);
    }
}
