...
const componentSelector = 'icon-salad-large';

export class IconSaladLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--saladLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--saladLarge', '', null, 'IconSaladLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--saladLarge', '', this.size, 'IconSaladLarge');
...
customElements.define(componentSelector, IconSaladLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSaladLarge;
    }
}
