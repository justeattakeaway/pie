...
export class IconCaretDown extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--caretDown');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--caretDown', '', newVal, 'IconCaretDown');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--caretDown', newVal);
    }
}

customElements.define('icon-caret-down', IconCaretDown);
