...
const componentSelector = 'icon-ribbon-heart';

export class IconRibbonHeart extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--ribbonHeart';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--ribbonHeart', '', this.size, 'IconRibbonHeart');
...
customElements.define(componentSelector, IconRibbonHeart);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRibbonHeart;
    }
}
