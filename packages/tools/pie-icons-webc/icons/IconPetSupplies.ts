...
const componentSelector = 'icon-pet-supplies';

export class IconPetSupplies extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--petSupplies';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--petSupplies', '', this.size, 'IconPetSupplies');
...
customElements.define(componentSelector, IconPetSupplies);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPetSupplies;
    }
}
