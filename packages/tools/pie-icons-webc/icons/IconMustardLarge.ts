...
const componentSelector = 'icon-mustard-large';

export class IconMustardLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--mustardLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mustardLarge', '', this.size, 'IconMustardLarge');
...
customElements.define(componentSelector, IconMustardLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMustardLarge;
    }
}
