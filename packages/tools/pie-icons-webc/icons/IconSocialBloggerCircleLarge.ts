...
const componentSelector = 'icon-social-blogger-circle-large';

export class IconSocialBloggerCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--bloggerCircleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bloggerCircleLarge', '', this.size, 'IconSocialBloggerCircleLarge');
