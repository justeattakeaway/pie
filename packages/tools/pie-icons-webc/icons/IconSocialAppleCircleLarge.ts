...
const componentSelector = 'icon-social-apple-circle-large';

export class IconSocialAppleCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appleCircleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleCircleLarge', '', this.size, 'IconSocialAppleCircleLarge');
...
customElements.define(componentSelector, IconSocialAppleCircleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAppleCircleLarge;
    }
}
