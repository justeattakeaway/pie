...
export class IconWifiLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wifiLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--wifiLarge', '', newVal, 'IconWifiLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wifiLarge', newVal);
    }
}
