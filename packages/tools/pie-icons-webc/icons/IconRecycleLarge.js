...
export class IconRecycleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--recycleLarge', '', null, 'IconRecycleLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--recycleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--recycleLarge', '', newVal, 'IconRecycleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--recycleLarge', newVal);
    }
}
