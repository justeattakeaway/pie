...
const componentSelector = 'icon-social-google-circle';

export class IconSocialGoogleCircle extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--googleCircle';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--googleCircle', '', this.size, 'IconSocialGoogleCircle');
...
customElements.define(componentSelector, IconSocialGoogleCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialGoogleCircle;
    }
}
