...
export class IconTutorialLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--tutorialLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--tutorialLarge', '', newVal, 'IconTutorialLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--tutorialLarge', newVal);
    }
}
