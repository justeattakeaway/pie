...
export class IconCalendarEdit extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarEdit');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarEdit', '', newVal, 'IconCalendarEdit');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarEdit', newVal);
    }
}
