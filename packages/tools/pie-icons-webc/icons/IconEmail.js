...
export class IconEmail extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--email');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--email', '', newVal, 'IconEmail');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--email', newVal);
    }
}
