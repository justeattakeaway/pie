...
const componentSelector = 'icon-offer-star-filled-large';

export class IconOfferStarFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--offerStarFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--offerStarFilledLarge', '', this.size, 'IconOfferStarFilledLarge');
...
customElements.define(componentSelector, IconOfferStarFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconOfferStarFilledLarge;
    }
}
