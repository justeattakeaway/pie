...
export class IconImageFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--imageFilledLarge', '', null, 'IconImageFilledLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--imageFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--imageFilledLarge', '', newVal, 'IconImageFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--imageFilledLarge', newVal);
    }
}
