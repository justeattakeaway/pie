...
export class IconPhoneFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--phoneFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--phoneFilledLarge', '', newVal, 'IconPhoneFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--phoneFilledLarge', newVal);
    }
}
