...
const componentSelector = 'icon-offer-star';

export class IconOfferStar extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--offerStar';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--offerStar', '', null, 'IconOfferStar');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--offerStar', '', this.size, 'IconOfferStar');
...
customElements.define(componentSelector, IconOfferStar);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconOfferStar;
    }
}
