...
export class IconBikeLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bikeLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bikeLarge', '', newVal, 'IconBikeLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bikeLarge', newVal);
    }
}
