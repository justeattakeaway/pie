...
export class IconGridViewFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--gridViewFilled', '', newVal, 'IconGridViewFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--gridViewFilled', newVal);
    }
}

customElements.define('icon-grid-view-filled', IconGridViewFilled);
