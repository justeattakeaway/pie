...
export class IconReceiptErrorLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--receiptErrorLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--receiptErrorLarge', '', newVal, 'IconReceiptErrorLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--receiptErrorLarge', newVal);
    }
}

customElements.define('icon-receipt-error-large', IconReceiptErrorLarge);
