...
const componentSelector = 'icon-user-circle';

export class IconUserCircle extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--userCircle';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userCircle', '', this.size, 'IconUserCircle');
...
customElements.define(componentSelector, IconUserCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUserCircle;
    }
}
