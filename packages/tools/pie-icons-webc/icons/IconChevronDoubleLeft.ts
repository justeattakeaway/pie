...
const componentSelector = 'icon-chevron-double-left';

export class IconChevronDoubleLeft extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--chevronDoubleLeft';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--chevronDoubleLeft', '', this.size, 'IconChevronDoubleLeft');
...
customElements.define(componentSelector, IconChevronDoubleLeft);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconChevronDoubleLeft;
    }
}
