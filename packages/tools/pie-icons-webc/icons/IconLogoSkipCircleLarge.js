...
export class IconLogoSkipCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--skipCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--skipCircleLarge', '', newVal, 'IconLogoSkipCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--skipCircleLarge', newVal);
    }
}
