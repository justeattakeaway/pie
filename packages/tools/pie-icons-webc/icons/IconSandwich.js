...
export class IconSandwich extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sandwich');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sandwich', '', newVal, 'IconSandwich');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sandwich', newVal);
    }
}

customElements.define('icon-sandwich', IconSandwich);
