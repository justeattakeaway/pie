...
const componentSelector = 'icon-atom-large';

export class IconAtomLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--atomLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--atomLarge', '', this.size, 'IconAtomLarge');
...
customElements.define(componentSelector, IconAtomLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAtomLarge;
    }
}
