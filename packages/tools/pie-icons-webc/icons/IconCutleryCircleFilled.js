...
export class IconCutleryCircleFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutleryCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryCircleFilled', '', newVal, 'IconCutleryCircleFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutleryCircleFilled', newVal);
    }
}
