...
const componentSelector = 'icon-flag-austria';

export class IconFlagAustria extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--austria';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--austria', '', this.size, 'IconFlagAustria');
...
customElements.define(componentSelector, IconFlagAustria);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFlagAustria;
    }
}
