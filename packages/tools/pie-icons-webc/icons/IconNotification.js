...
export class IconNotification extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--notification');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--notification', '', newVal, 'IconNotification');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--notification', newVal);
    }
}
