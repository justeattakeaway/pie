...
export class IconLocationPinUserLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinUserLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinUserLarge', '', newVal, 'IconLocationPinUserLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinUserLarge', newVal);
    }
}
