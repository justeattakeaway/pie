...
export class IconPlaneLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--planeLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--planeLarge', '', newVal, 'IconPlaneLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--planeLarge', newVal);
    }
}
