...
export class IconShare extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--share');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--share', '', newVal, 'IconShare');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--share', newVal);
    }
}
