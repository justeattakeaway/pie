...
export class IconUsersLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--usersLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--usersLarge', '', newVal, 'IconUsersLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--usersLarge', newVal);
    }
}
