...
export class IconHouse extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--house');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--house', '', newVal, 'IconHouse');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--house', newVal);
    }
}
