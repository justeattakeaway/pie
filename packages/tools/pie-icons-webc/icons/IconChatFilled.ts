...
const componentSelector = 'icon-chat-filled';

export class IconChatFilled extends LitElement implements IconProps {
    static styles = css`
    ...
    @property({ type: String, reflect: true })
    public class = 'c-pieIcon c-pieIcon--chatFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--chatFilled', '', this.size, 'IconChatFilled');
...
customElements.define(componentSelector, IconChatFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconChatFilled;
    }
}
