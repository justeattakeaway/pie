...
export class IconNachosLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--nachosLarge', '', null, 'IconNachosLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--nachosLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--nachosLarge', '', newVal, 'IconNachosLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--nachosLarge', newVal);
    }
}
