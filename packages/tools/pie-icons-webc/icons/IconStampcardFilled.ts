...
const componentSelector = 'icon-stampcard-filled';

export class IconStampcardFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcardFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcardFilled', '', this.size, 'IconStampcardFilled');
...
customElements.define(componentSelector, IconStampcardFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcardFilled;
    }
}
