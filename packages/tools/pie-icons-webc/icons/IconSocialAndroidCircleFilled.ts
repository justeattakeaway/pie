...
const componentSelector = 'icon-social-android-circle-filled';

export class IconSocialAndroidCircleFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--androidCircleFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--androidCircleFilled', '', this.size, 'IconSocialAndroidCircleFilled');
...
customElements.define(componentSelector, IconSocialAndroidCircleFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAndroidCircleFilled;
    }
}
