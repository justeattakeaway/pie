...
export class IconVision extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--vision');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--vision', '', newVal, 'IconVision');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--vision', newVal);
    }
}
