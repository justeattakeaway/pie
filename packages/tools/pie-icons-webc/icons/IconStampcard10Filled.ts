...
const componentSelector = 'icon-stampcard10-filled';

export class IconStampcard10Filled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcard10Filled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcard10Filled', '', this.size, 'IconStampcard10Filled');
...
customElements.define(componentSelector, IconStampcard10Filled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcard10Filled;
    }
}
