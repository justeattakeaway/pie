...
export class IconComponentsLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--componentsLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--componentsLarge', '', newVal, 'IconComponentsLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--componentsLarge', newVal);
    }
}
