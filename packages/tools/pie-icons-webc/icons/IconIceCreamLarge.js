...
export class IconIceCreamLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--iceCreamLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--iceCreamLarge', '', newVal, 'IconIceCreamLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--iceCreamLarge', newVal);
    }
}

customElements.define('icon-ice-cream-large', IconIceCreamLarge);
