...
export class IconRibbonStarLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--ribbonStarLarge', newVal);
    }
}
