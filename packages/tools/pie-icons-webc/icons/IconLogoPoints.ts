...
const componentSelector = 'icon-logo-points';

export class IconLogoPoints extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--points';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--points', '', this.size, 'IconLogoPoints');
...
customElements.define(componentSelector, IconLogoPoints);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLogoPoints;
    }
}
