...
export class IconNumberSymbol extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--numberSymbol', newVal);
    }
}
