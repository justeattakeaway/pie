...
export class IconSocialLinkedinCircleFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinCircleFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinCircleFilledLarge', '', newVal, 'IconSocialLinkedinCircleFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinCircleFilledLarge', newVal);
    }
}
