...
const componentSelector = 'icon-social-apple-circle-filled';

export class IconSocialAppleCircleFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appleCircleFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleCircleFilled', '', this.size, 'IconSocialAppleCircleFilled');
...
customElements.define(componentSelector, IconSocialAppleCircleFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAppleCircleFilled;
    }
}
