...
export class IconCreditCardHomeFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--creditCardHomeFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--creditCardHomeFilled', '', newVal, 'IconCreditCardHomeFilled');
