...
const componentSelector = 'icon-ribbon-heart-large';

export class IconRibbonHeartLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--ribbonHeartLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--ribbonHeartLarge', '', this.size, 'IconRibbonHeartLarge');
...
customElements.define(componentSelector, IconRibbonHeartLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRibbonHeartLarge;
    }
}
