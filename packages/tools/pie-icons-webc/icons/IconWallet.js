...
export class IconWallet extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wallet');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--wallet', '', newVal, 'IconWallet');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wallet', newVal);
    }
}
