...
const componentSelector = 'icon-payment-klarna';

export class IconPaymentKlarna extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--klarna';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--klarna', '', this.size, 'IconPaymentKlarna');
...
customElements.define(componentSelector, IconPaymentKlarna);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentKlarna;
    }
}
