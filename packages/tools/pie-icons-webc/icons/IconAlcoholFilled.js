...
export class IconAlcoholFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alcoholFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--alcoholFilled', '', newVal, 'IconAlcoholFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alcoholFilled', newVal);
    }
}
