...
export class IconVeganLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--veganLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--veganLarge', '', newVal, 'IconVeganLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--veganLarge', newVal);
    }
}
