...
export class IconPickUp extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pickUp');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pickUp', '', newVal, 'IconPickUp');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pickUp', newVal);
    }
}
