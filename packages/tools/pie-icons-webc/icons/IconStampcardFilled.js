...
export class IconStampcardFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stampcardFilled', newVal);
    }
}
