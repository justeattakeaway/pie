...
const componentSelector = 'icon-payment-mobile-pay';

export class IconPaymentMobilePay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--mobilePay';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--mobilePay', '', null, 'IconPaymentMobilePay');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mobilePay', '', this.size, 'IconPaymentMobilePay');
...
customElements.define(componentSelector, IconPaymentMobilePay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentMobilePay;
    }
}
