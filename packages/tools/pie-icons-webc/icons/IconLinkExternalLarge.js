...
export class IconLinkExternalLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkExternalLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkExternalLarge', '', newVal, 'IconLinkExternalLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkExternalLarge', newVal);
    }
}
