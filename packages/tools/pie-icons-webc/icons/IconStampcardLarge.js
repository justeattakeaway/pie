...
export class IconStampcardLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stampcardLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcardLarge', '', newVal, 'IconStampcardLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stampcardLarge', newVal);
    }
}
