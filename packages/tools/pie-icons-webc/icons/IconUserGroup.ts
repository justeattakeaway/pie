...
const componentSelector = 'icon-user-group';

export class IconUserGroup extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--userGroup';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userGroup', '', this.size, 'IconUserGroup');
...
customElements.define(componentSelector, IconUserGroup);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUserGroup;
    }
}
