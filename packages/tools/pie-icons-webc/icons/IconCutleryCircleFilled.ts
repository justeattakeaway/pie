...
const componentSelector = 'icon-cutlery-circle-filled';

export class IconCutleryCircleFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cutleryCircleFilled';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryCircleFilled', '', null, 'IconCutleryCircleFilled');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryCircleFilled', '', this.size, 'IconCutleryCircleFilled');
...
customElements.define(componentSelector, IconCutleryCircleFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCutleryCircleFilled;
    }
}
