...
const componentSelector = 'icon-prepare-large';

export class IconPrepareLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--prepareLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--prepareLarge', '', null, 'IconPrepareLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--prepareLarge', '', this.size, 'IconPrepareLarge');
...
customElements.define(componentSelector, IconPrepareLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPrepareLarge;
    }
}
