...
const componentSelector = 'icon-swiss-franc-large';

export class IconSwissFrancLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--swissFrancLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--swissFrancLarge', '', this.size, 'IconSwissFrancLarge');
...
customElements.define(componentSelector, IconSwissFrancLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSwissFrancLarge;
    }
}
