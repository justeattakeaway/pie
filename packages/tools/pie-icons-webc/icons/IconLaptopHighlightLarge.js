...
export class IconLaptopHighlightLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--laptopHighlightLarge', newVal);
    }
}
