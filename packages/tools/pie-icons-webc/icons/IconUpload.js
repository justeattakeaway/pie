...
export class IconUpload extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--upload');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--upload', '', newVal, 'IconUpload');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--upload', newVal);
    }
}
