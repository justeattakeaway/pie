...
export class IconGroceryLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--groceryLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--groceryLarge', '', newVal, 'IconGroceryLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--groceryLarge', newVal);
    }
}

customElements.define('icon-grocery-large', IconGroceryLarge);
