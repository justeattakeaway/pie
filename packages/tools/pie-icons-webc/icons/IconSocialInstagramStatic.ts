...
const componentSelector = 'icon-social-instagram-static';

export class IconSocialInstagramStatic extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--instagramStatic';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--instagramStatic', '', this.size, 'IconSocialInstagramStatic');
...
customElements.define(componentSelector, IconSocialInstagramStatic);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialInstagramStatic;
    }
}
