...
const componentSelector = 'icon-cutlery-filled-large';

export class IconCutleryFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cutleryFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryFilledLarge', '', this.size, 'IconCutleryFilledLarge');
...
customElements.define(componentSelector, IconCutleryFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCutleryFilledLarge;
    }
}
