...
export class IconToiletLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--toiletLarge', '', null, 'IconToiletLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--toiletLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--toiletLarge', '', newVal, 'IconToiletLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--toiletLarge', newVal);
    }
}
