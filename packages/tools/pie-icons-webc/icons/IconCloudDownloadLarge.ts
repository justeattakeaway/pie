...
const componentSelector = 'icon-cloud-download-large';

export class IconCloudDownloadLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cloudDownloadLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudDownloadLarge', '', this.size, 'IconCloudDownloadLarge');
...
customElements.define(componentSelector, IconCloudDownloadLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCloudDownloadLarge;
    }
}
