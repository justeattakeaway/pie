...
const componentSelector = 'icon-calendar-add-large';

export class IconCalendarAddLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--calendarAddLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarAddLarge', '', this.size, 'IconCalendarAddLarge');
...
customElements.define(componentSelector, IconCalendarAddLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCalendarAddLarge;
    }
}
