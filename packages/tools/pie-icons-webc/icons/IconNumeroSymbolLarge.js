...
export class IconNumeroSymbolLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--numeroSymbolLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--numeroSymbolLarge', '', newVal, 'IconNumeroSymbolLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--numeroSymbolLarge', newVal);
    }
}
