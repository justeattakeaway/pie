...
export class IconTranslateFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--translateFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--translateFilled', '', newVal, 'IconTranslateFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--translateFilled', newVal);
    }
}
