...
export class IconFoodFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--foodFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--foodFilledLarge', '', newVal, 'IconFoodFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--foodFilledLarge', newVal);
    }
}

customElements.define('icon-food-filled-large', IconFoodFilledLarge);
