...
export class IconRoutePinLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--routePinLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--routePinLarge', '', newVal, 'IconRoutePinLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--routePinLarge', newVal);
    }
}
