...
export class IconGeolocation extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--geolocation');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--geolocation', '', newVal, 'IconGeolocation');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--geolocation', newVal);
    }
}
