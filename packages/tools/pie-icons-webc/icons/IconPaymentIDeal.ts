...
const componentSelector = 'icon-payment-i-deal';

export class IconPaymentIDeal extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--iDeal';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--iDeal', '', this.size, 'IconPaymentIDeal');
...
customElements.define(componentSelector, IconPaymentIDeal);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentIDeal;
    }
}
