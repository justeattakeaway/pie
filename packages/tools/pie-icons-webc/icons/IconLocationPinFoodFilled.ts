...
const componentSelector = 'icon-location-pin-food-filled';

export class IconLocationPinFoodFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--locationPinFoodFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinFoodFilled', '', this.size, 'IconLocationPinFoodFilled');
...
customElements.define(componentSelector, IconLocationPinFoodFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLocationPinFoodFilled;
    }
}
