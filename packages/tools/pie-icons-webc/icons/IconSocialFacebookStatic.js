...
export class IconSocialFacebookStatic extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--facebookStatic');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--facebookStatic', '', newVal, 'IconSocialFacebookStatic');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--facebookStatic', newVal);
    }
}
