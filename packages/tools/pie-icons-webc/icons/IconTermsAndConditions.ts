...
const componentSelector = 'icon-terms-and-conditions';

export class IconTermsAndConditions extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--termsAndConditions';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--termsAndConditions', '', this.size, 'IconTermsAndConditions');
...
customElements.define(componentSelector, IconTermsAndConditions);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTermsAndConditions;
    }
}
