...
export class IconCheckboxUnselectedLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--checkboxUnselectedLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--checkboxUnselectedLarge', '', newVal, 'IconCheckboxUnselectedLarge');
