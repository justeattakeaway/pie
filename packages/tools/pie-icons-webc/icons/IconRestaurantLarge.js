...
export class IconRestaurantLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--restaurantLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--restaurantLarge', '', newVal, 'IconRestaurantLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--restaurantLarge', newVal);
    }
}

customElements.define('icon-restaurant-large', IconRestaurantLarge);
