...
const componentSelector = 'icon-settings-filled';

export class IconSettingsFilled extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--settingsFilled';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--settingsFilled', '', null, 'IconSettingsFilled');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--settingsFilled', '', this.size, 'IconSettingsFilled');
...
customElements.define(componentSelector, IconSettingsFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSettingsFilled;
    }
}
