...
export class IconSocialApple extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--apple');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--apple', '', newVal, 'IconSocialApple');
...
customElements.define('icon-social-apple', IconSocialApple);
