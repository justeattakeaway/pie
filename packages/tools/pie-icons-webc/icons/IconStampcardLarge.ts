...
const componentSelector = 'icon-stampcard-large';

export class IconStampcardLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcardLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcardLarge', '', null, 'IconStampcardLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcardLarge', '', this.size, 'IconStampcardLarge');
...
customElements.define(componentSelector, IconStampcardLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcardLarge;
    }
}
