...
const componentSelector = 'icon-vision-large';

export class IconVisionLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--visionLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--visionLarge', '', this.size, 'IconVisionLarge');
...
customElements.define(componentSelector, IconVisionLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconVisionLarge;
    }
}
