...
export class IconChartIncrease extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--chartIncrease');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--chartIncrease', '', newVal, 'IconChartIncrease');
