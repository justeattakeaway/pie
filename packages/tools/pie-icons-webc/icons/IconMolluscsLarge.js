...
export class IconMolluscsLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--molluscsLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--molluscsLarge', '', newVal, 'IconMolluscsLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--molluscsLarge', newVal);
    }
}

customElements.define('icon-molluscs-large', IconMolluscsLarge);
