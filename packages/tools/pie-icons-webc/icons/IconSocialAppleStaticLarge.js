...
export class IconSocialAppleStaticLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--appleStaticLarge', '', null, 'IconSocialAppleStaticLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleStaticLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleStaticLarge', '', newVal, 'IconSocialAppleStaticLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleStaticLarge', newVal);
    }
}
