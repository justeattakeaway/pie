...
export class IconKosher extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kosher');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--kosher', '', newVal, 'IconKosher');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kosher', newVal);
    }
}
