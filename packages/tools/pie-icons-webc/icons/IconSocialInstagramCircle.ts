...
const componentSelector = 'icon-social-instagram-circle';

export class IconSocialInstagramCircle extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--instagramCircle';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--instagramCircle', '', this.size, 'IconSocialInstagramCircle');
...
customElements.define(componentSelector, IconSocialInstagramCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialInstagramCircle;
    }
}
