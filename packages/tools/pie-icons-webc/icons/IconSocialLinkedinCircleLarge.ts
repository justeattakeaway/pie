...
const componentSelector = 'icon-social-linkedin-circle-large';

export class IconSocialLinkedinCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--linkedinCircleLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinCircleLarge', '', null, 'IconSocialLinkedinCircleLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinCircleLarge', '', this.size, 'IconSocialLinkedinCircleLarge');
...
customElements.define(componentSelector, IconSocialLinkedinCircleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialLinkedinCircleLarge;
    }
}
