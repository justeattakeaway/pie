...
export class IconCheque extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cheque');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cheque', '', newVal, 'IconCheque');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cheque', newVal);
    }
}
