...
const componentSelector = 'icon-stampcard10-large';

export class IconStampcard10Large extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcard10Large';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcard10Large', '', this.size, 'IconStampcard10Large');
...
customElements.define(componentSelector, IconStampcard10Large);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcard10Large;
    }
}
