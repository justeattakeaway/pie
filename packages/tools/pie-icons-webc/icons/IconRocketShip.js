...
export class IconRocketShip extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--rocketShip');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--rocketShip', '', newVal, 'IconRocketShip');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--rocketShip', newVal);
    }
}
