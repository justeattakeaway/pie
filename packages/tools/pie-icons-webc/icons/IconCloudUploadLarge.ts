...
const componentSelector = 'icon-cloud-upload-large';

export class IconCloudUploadLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cloudUploadLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudUploadLarge', '', this.size, 'IconCloudUploadLarge');
...
customElements.define(componentSelector, IconCloudUploadLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCloudUploadLarge;
    }
}
