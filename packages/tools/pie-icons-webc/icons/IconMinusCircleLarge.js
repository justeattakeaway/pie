...
export class IconMinusCircleLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--minusCircleLarge', '', newVal, 'IconMinusCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--minusCircleLarge', newVal);
    }
}

customElements.define('icon-minus-circle-large', IconMinusCircleLarge);
