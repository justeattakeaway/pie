...
export class IconChatHelpLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--chatHelpLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--chatHelpLarge', '', newVal, 'IconChatHelpLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--chatHelpLarge', newVal);
    }
}
