...
const componentSelector = 'icon-ribbon-star-large';

export class IconRibbonStarLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--ribbonStarLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--ribbonStarLarge', '', this.size, 'IconRibbonStarLarge');
...
customElements.define(componentSelector, IconRibbonStarLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRibbonStarLarge;
    }
}
