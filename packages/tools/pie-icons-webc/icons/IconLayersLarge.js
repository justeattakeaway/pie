...
export class IconLayersLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--layersLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--layersLarge', '', newVal, 'IconLayersLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--layersLarge', newVal);
    }
}
