...
const componentSelector = 'icon-prepare-pause';

export class IconPreparePause extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--preparePause';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--preparePause', '', null, 'IconPreparePause');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--preparePause', '', this.size, 'IconPreparePause');
...
customElements.define(componentSelector, IconPreparePause);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPreparePause;
    }
}
