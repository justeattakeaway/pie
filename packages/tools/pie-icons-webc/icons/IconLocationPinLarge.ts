...
const componentSelector = 'icon-location-pin-large';

export class IconLocationPinLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--locationPinLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinLarge', '', this.size, 'IconLocationPinLarge');
...
customElements.define(componentSelector, IconLocationPinLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLocationPinLarge;
    }
}
