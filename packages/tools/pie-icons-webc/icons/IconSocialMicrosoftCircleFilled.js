...
export class IconSocialMicrosoftCircleFilled extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microsoftCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--microsoftCircleFilled', '', newVal, 'IconSocialMicrosoftCircleFilled');
...
customElements.define('icon-social-microsoft-circle-filled', IconSocialMicrosoftCircleFilled);
