...
const componentSelector = 'icon-alcohol-filled-large';

export class IconAlcoholFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--alcoholFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--alcoholFilledLarge', '', this.size, 'IconAlcoholFilledLarge');
...
customElements.define(componentSelector, IconAlcoholFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAlcoholFilledLarge;
    }
}
