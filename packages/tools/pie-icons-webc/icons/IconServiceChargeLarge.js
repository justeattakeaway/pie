...
export class IconServiceChargeLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--serviceChargeLarge', '', null, 'IconServiceChargeLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--serviceChargeLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--serviceChargeLarge', '', newVal, 'IconServiceChargeLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--serviceChargeLarge', newVal);
    }
}
