...
export class IconSocialGoogleCircleFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--googleCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--googleCircleFilled', '', newVal, 'IconSocialGoogleCircleFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--googleCircleFilled', newVal);
    }
}
