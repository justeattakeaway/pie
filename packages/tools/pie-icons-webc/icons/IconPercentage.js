...
export class IconPercentage extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--percentage');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--percentage', '', newVal, 'IconPercentage');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--percentage', newVal);
    }
}
