...
export class IconLogoSkipCircleFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--skipCircleFilled', newVal);
    }
}
