...
const componentSelector = 'icon-hand-coins';

export class IconHandCoins extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--handCoins';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--handCoins', '', this.size, 'IconHandCoins');
...
customElements.define(componentSelector, IconHandCoins);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHandCoins;
    }
}
