...
export class IconNotificationLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--notificationLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--notificationLarge', '', newVal, 'IconNotificationLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--notificationLarge', newVal);
    }
}
