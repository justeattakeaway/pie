...
const componentSelector = 'icon-conversion-rate-large';

export class IconConversionRateLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--conversionRateLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--conversionRateLarge', '', this.size, 'IconConversionRateLarge');
...
customElements.define(componentSelector, IconConversionRateLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconConversionRateLarge;
    }
}
