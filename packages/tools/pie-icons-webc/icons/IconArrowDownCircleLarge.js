...
export class IconArrowDownCircleLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--arrowDownCircleLarge', newVal);
    }
}
