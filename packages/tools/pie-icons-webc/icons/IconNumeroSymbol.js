...
export class IconNumeroSymbol extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--numeroSymbol');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--numeroSymbol', '', newVal, 'IconNumeroSymbol');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--numeroSymbol', newVal);
    }
}
