...
export class IconPrepareLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--prepareLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--prepareLarge', '', newVal, 'IconPrepareLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--prepareLarge', newVal);
    }
}
