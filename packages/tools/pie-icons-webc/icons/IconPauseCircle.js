...
export class IconPauseCircle extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pauseCircle');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pauseCircle', '', newVal, 'IconPauseCircle');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pauseCircle', newVal);
    }
}

customElements.define('icon-pause-circle', IconPauseCircle);
