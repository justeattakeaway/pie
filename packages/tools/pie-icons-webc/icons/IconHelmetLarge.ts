...
const componentSelector = 'icon-helmet-large';

export class IconHelmetLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--helmetLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--helmetLarge', '', null, 'IconHelmetLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--helmetLarge', '', this.size, 'IconHelmetLarge');
...
customElements.define(componentSelector, IconHelmetLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHelmetLarge;
    }
}
