...
const componentSelector = 'icon-pet-supplies-large';

export class IconPetSuppliesLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--petSuppliesLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--petSuppliesLarge', '', null, 'IconPetSuppliesLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--petSuppliesLarge', '', this.size, 'IconPetSuppliesLarge');
...
customElements.define(componentSelector, IconPetSuppliesLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPetSuppliesLarge;
    }
}
