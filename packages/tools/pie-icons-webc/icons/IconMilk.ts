...
const componentSelector = 'icon-milk';

export class IconMilk extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--milk';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--milk', '', this.size, 'IconMilk');
...
customElements.define(componentSelector, IconMilk);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMilk;
    }
}
