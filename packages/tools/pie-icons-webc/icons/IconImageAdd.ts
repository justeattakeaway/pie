...
export class IconImageAdd extends LitElement implements IconProps {
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--imageAdd', '', this.size, 'IconImageAdd');
...
customElements.define(componentSelector, IconImageAdd);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconImageAdd;
    }
}
