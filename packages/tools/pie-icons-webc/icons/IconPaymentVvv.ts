...
const componentSelector = 'icon-payment-vvv';

export class IconPaymentVvv extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--vvv';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--vvv', '', this.size, 'IconPaymentVvv');
...
customElements.define(componentSelector, IconPaymentVvv);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentVvv;
    }
}
