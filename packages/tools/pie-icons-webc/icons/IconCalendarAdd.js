...
export class IconCalendarAdd extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarAdd');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarAdd', '', newVal, 'IconCalendarAdd');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarAdd', newVal);
    }
}
