...
const componentSelector = 'icon-payment-payu';

export class IconPaymentPayu extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--payu';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--payu', '', this.size, 'IconPaymentPayu');
...
customElements.define(componentSelector, IconPaymentPayu);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentPayu;
    }
}
