...
const componentSelector = 'icon-social-blogger-static-large';

export class IconSocialBloggerStaticLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--bloggerStaticLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--bloggerStaticLarge', '', null, 'IconSocialBloggerStaticLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bloggerStaticLarge', '', this.size, 'IconSocialBloggerStaticLarge');
...
customElements.define(componentSelector, IconSocialBloggerStaticLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialBloggerStaticLarge;
    }
}
