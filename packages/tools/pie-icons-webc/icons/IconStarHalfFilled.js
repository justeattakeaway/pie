...
export class IconStarHalfFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--starHalfFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--starHalfFilled', '', newVal, 'IconStarHalfFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--starHalfFilled', newVal);
    }
}
