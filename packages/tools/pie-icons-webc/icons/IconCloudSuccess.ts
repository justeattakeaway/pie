...
export class IconCloudSuccess extends LitElement implements IconProps {
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudSuccess', '', this.size, 'IconCloudSuccess');
...
customElements.define(componentSelector, IconCloudSuccess);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCloudSuccess;
    }
}
