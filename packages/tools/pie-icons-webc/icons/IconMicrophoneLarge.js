...
export class IconMicrophoneLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microphoneLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--microphoneLarge', '', newVal, 'IconMicrophoneLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microphoneLarge', newVal);
    }
}
