...
const componentSelector = 'icon-takeaway-pay-large';

export class IconTakeawayPayLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--takeawayPayLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--takeawayPayLarge', '', this.size, 'IconTakeawayPayLarge');
...
customElements.define(componentSelector, IconTakeawayPayLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTakeawayPayLarge;
    }
}
