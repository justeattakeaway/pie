...
export class IconSocialAndroidCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--androidCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--androidCircleLarge', '', newVal, 'IconSocialAndroidCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--androidCircleLarge', newVal);
    }
}
