...
export class IconLocationPinFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinFilledLarge', '', newVal, 'IconLocationPinFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinFilledLarge', newVal);
    }
}
