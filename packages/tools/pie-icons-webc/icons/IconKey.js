...
export class IconKey extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--key');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--key', '', newVal, 'IconKey');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--key', newVal);
    }
}
