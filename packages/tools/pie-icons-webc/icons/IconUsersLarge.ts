...
const componentSelector = 'icon-users-large';

export class IconUsersLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--usersLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--usersLarge', '', null, 'IconUsersLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--usersLarge', '', this.size, 'IconUsersLarge');
...
customElements.define(componentSelector, IconUsersLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUsersLarge;
    }
}
