...
export class IconCloudError extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloudError');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudError', '', newVal, 'IconCloudError');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloudError', newVal);
    }
}
