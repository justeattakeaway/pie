...
export class IconRestaurantFilledLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--restaurantFilledLarge', newVal);
    }
}
