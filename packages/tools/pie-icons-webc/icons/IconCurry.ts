...
const componentSelector = 'icon-curry';

export class IconCurry extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--curry';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--curry', '', this.size, 'IconCurry');
...
customElements.define(componentSelector, IconCurry);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCurry;
    }
}
