...
const componentSelector = 'icon-clock-large';

export class IconClockLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--clockLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--clockLarge', '', this.size, 'IconClockLarge');
...
customElements.define(componentSelector, IconClockLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconClockLarge;
    }
}
