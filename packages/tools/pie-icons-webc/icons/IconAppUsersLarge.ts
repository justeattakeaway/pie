...
const componentSelector = 'icon-app-users-large';

export class IconAppUsersLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appUsersLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appUsersLarge', '', this.size, 'IconAppUsersLarge');
...
customElements.define(componentSelector, IconAppUsersLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAppUsersLarge;
    }
}
