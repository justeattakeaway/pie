...
export default class IconCloudSuccessLarge extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconCloudSuccessLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconCloudSuccessLarge');
