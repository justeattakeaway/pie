...
export class IconReceiptError extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--receiptError');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--receiptError', '', newVal, 'IconReceiptError');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--receiptError', newVal);
    }
}
