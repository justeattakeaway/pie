...
const componentSelector = 'icon-vegetarian-large';

export class IconVegetarianLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--vegetarianLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--vegetarianLarge', '', this.size, 'IconVegetarianLarge');
...
customElements.define(componentSelector, IconVegetarianLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconVegetarianLarge;
    }
}
