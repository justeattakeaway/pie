...
export class IconPhoneLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--phoneLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--phoneLarge', '', newVal, 'IconPhoneLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--phoneLarge', newVal);
    }
}

customElements.define('icon-phone-large', IconPhoneLarge);
