...
export class IconEyeOffFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eyeOffFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--eyeOffFilledLarge', '', newVal, 'IconEyeOffFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eyeOffFilledLarge', newVal);
    }
}
