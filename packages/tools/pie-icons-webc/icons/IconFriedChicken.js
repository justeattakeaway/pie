...
export class IconFriedChicken extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--friedChicken');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--friedChicken', '', newVal, 'IconFriedChicken');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--friedChicken', newVal);
    }
}

customElements.define('icon-fried-chicken', IconFriedChicken);
