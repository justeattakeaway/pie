...
export class IconSocialAppleCircleFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleCircleFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleCircleFilledLarge', '', newVal, 'IconSocialAppleCircleFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleCircleFilledLarge', newVal);
    }
}
