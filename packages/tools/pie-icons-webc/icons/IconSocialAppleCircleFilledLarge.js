...
export class IconSocialAppleCircleFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--appleCircleFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--appleCircleFilledLarge', '', newVal, 'IconSocialAppleCircleFilledLarge');
