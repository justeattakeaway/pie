...
const componentSelector = 'icon-social-twitter-static';

export class IconSocialTwitterStatic extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--twitterStatic';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--twitterStatic', '', this.size, 'IconSocialTwitterStatic');
...
customElements.define(componentSelector, IconSocialTwitterStatic);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialTwitterStatic;
    }
}
