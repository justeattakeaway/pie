...
export class IconMinusLarge extends LitElement implements IconProps {
    ...
    @property({ type: String, reflect: true })
    public class = 'c-pieIcon c-pieIcon--minusLarge';
    ...
    render () : TemplateResult {
        return html`<svg xmlns="http://www.w3.org/2000/svg" role="presentation" focusable="false" fill="currentColor" viewBox="0 0 32 32" class="c-pieIcon c-pieIcon--minusLarge"><path d="M27.375 16.875v-1.75H4.625v1.75h22.75Z"></path></svg>`;
    }
}
