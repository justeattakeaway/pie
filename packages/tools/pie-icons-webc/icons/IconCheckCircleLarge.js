...
export class IconCheckCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--checkCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--checkCircleLarge', '', newVal, 'IconCheckCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--checkCircleLarge', newVal);
    }
}
