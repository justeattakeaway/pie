...
const componentSelector = 'icon-more-vertical-large';

export class IconMoreVerticalLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--moreVerticalLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--moreVerticalLarge', '', this.size, 'IconMoreVerticalLarge');
...
customElements.define(componentSelector, IconMoreVerticalLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMoreVerticalLarge;
    }
}
