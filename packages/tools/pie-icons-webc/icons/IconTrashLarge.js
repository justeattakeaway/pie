...
export class IconTrashLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--trashLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--trashLarge', '', newVal, 'IconTrashLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--trashLarge', newVal);
    }
}
