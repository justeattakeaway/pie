...
export class IconSocialTwitterCircleFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--twitterCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--twitterCircleFilled', '', newVal, 'IconSocialTwitterCircleFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--twitterCircleFilled', newVal);
    }
}
