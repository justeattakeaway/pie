...
export class IconSun extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sun');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sun', '', newVal, 'IconSun');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sun', newVal);
    }
}
