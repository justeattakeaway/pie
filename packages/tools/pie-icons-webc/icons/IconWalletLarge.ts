...
const componentSelector = 'icon-wallet-large';

export class IconWalletLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--walletLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--walletLarge', '', this.size, 'IconWalletLarge');
...
customElements.define(componentSelector, IconWalletLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconWalletLarge;
    }
}
