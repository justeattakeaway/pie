...
export class IconEggs extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eggs');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--eggs', '', newVal, 'IconEggs');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eggs', newVal);
    }
}
