...
export class IconBrandHighlightLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--brandHighlightLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--brandHighlightLarge', '', newVal, 'IconBrandHighlightLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--brandHighlightLarge', newVal);
    }
}

customElements.define('icon-brand-highlight-large', IconBrandHighlightLarge);
