...
export class IconSocialInstagramCircleLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--instagramCircleLarge', newVal);
    }
}
