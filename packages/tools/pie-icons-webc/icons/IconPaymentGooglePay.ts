...
const componentSelector = 'icon-payment-google-pay';

export class IconPaymentGooglePay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--googlePay';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--googlePay', '', this.size, 'IconPaymentGooglePay');
...
customElements.define(componentSelector, IconPaymentGooglePay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentGooglePay;
    }
}
