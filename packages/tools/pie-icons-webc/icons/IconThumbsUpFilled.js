...
export class IconThumbsUpFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsUpFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsUpFilled', '', newVal, 'IconThumbsUpFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsUpFilled', newVal);
    }
}
