...
export class IconEyeOnLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eyeOnLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--eyeOnLarge', '', newVal, 'IconEyeOnLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--eyeOnLarge', newVal);
    }
}
