...
const componentSelector = 'icon-payment-sodexo';

export class IconPaymentSodexo extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--sodexo';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sodexo', '', this.size, 'IconPaymentSodexo');
...
customElements.define(componentSelector, IconPaymentSodexo);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentSodexo;
    }
}
