...
export default class IconCaretDownFilled extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconCaretDownFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconCaretDownFilled');
...
customElements.define('icon-caret-down-filled', IconCaretDownFilled);
