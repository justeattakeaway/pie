...
export class IconPreparePause extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--preparePause');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--preparePause', '', newVal, 'IconPreparePause');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--preparePause', newVal);
    }
}
