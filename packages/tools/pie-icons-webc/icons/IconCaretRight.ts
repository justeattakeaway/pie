...
const componentSelector = 'icon-caret-right';

export class IconCaretRight extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--caretRight';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--caretRight', '', this.size, 'IconCaretRight');
...
customElements.define(componentSelector, IconCaretRight);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCaretRight;
    }
}
