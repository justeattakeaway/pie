...
export class IconCalendarStarLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarStarLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--calendarStarLarge', '', newVal, 'IconCalendarStarLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--calendarStarLarge', newVal);
    }
}
