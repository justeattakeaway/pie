...
export class IconUserHighlight extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userHighlight');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userHighlight', '', newVal, 'IconUserHighlight');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userHighlight', newVal);
    }
}
