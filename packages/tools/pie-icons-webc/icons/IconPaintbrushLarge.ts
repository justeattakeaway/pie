...
const componentSelector = 'icon-paintbrush-large';

export class IconPaintbrushLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--paintbrushLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--paintbrushLarge', '', this.size, 'IconPaintbrushLarge');
...
customElements.define(componentSelector, IconPaintbrushLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaintbrushLarge;
    }
}
