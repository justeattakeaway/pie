...
export class IconHelmetLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--helmetLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--helmetLarge', '', newVal, 'IconHelmetLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--helmetLarge', newVal);
    }
}
