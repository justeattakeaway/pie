...
export class IconLocationPinFoodFilledLarge extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinFoodFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinFoodFilledLarge', '', newVal, 'IconLocationPinFoodFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--locationPinFoodFilledLarge', newVal);
    }
}

customElements.define('icon-location-pin-food-filled-large', IconLocationPinFoodFilledLarge);
