...
const componentSelector = 'icon-payment-giropay';

export class IconPaymentGiropay extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--giropay';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--giropay', '', this.size, 'IconPaymentGiropay');
...
customElements.define(componentSelector, IconPaymentGiropay);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentGiropay;
    }
}
