...
const componentSelector = 'icon-restaurant';

export class IconRestaurant extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--restaurant';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--restaurant', '', this.size, 'IconRestaurant');
...
customElements.define(componentSelector, IconRestaurant);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRestaurant;
    }
}
