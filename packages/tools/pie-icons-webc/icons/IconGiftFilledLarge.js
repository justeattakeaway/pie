...
export class IconGiftFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--giftFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--giftFilledLarge', '', newVal, 'IconGiftFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--giftFilledLarge', newVal);
    }
}
