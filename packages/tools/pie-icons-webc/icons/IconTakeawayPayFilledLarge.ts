...
const componentSelector = 'icon-takeaway-pay-filled-large';

export class IconTakeawayPayFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--takeawayPayFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--takeawayPayFilledLarge', '', this.size, 'IconTakeawayPayFilledLarge');
...
customElements.define(componentSelector, IconTakeawayPayFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTakeawayPayFilledLarge;
    }
}
