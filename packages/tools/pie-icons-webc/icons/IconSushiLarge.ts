...
const componentSelector = 'icon-sushi-large';

export class IconSushiLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--sushiLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sushiLarge', '', this.size, 'IconSushiLarge');
...
customElements.define(componentSelector, IconSushiLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSushiLarge;
    }
}
