...
const componentSelector = 'icon-kosher-large';

export class IconKosherLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--kosherLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--kosherLarge', '', this.size, 'IconKosherLarge');
...
customElements.define(componentSelector, IconKosherLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconKosherLarge;
    }
}
