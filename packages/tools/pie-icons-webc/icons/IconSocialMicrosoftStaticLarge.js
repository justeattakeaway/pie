...
export class IconSocialMicrosoftStaticLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--microsoftStaticLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--microsoftStaticLarge', '', newVal, 'IconSocialMicrosoftStaticLarge');
...
customElements.define('icon-social-microsoft-static-large', IconSocialMicrosoftStaticLarge);
