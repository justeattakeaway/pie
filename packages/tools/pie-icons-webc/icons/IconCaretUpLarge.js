...
export default class IconCaretUpLarge extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconCaretUpLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconCaretUpLarge');
...
customElements.define('icon-caret-up-large', IconCaretUpLarge);
