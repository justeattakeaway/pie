...
export class IconMicrophone extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microphone');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--microphone', '', newVal, 'IconMicrophone');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--microphone', newVal);
    }
}
