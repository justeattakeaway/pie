...
const componentSelector = 'icon-at-symbol-large';

export class IconAtSymbolLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--atSymbolLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--atSymbolLarge', '', this.size, 'IconAtSymbolLarge');
...
customElements.define(componentSelector, IconAtSymbolLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAtSymbolLarge;
    }
}
