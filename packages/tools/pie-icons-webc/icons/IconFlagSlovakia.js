...
export class IconFlagSlovakia extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--slovakia');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--slovakia', '', newVal, 'IconFlagSlovakia');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--slovakia', newVal);
    }
}

customElements.define('icon-flag-slovakia', IconFlagSlovakia);
