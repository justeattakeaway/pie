...
const componentSelector = 'icon-google-voice';

export class IconGoogleVoice extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--googleVoice';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--googleVoice', '', this.size, 'IconGoogleVoice');
...
customElements.define(componentSelector, IconGoogleVoice);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconGoogleVoice;
    }
}
