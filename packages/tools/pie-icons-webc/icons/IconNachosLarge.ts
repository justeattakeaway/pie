...
const componentSelector = 'icon-nachos-large';

export class IconNachosLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--nachosLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--nachosLarge', '', this.size, 'IconNachosLarge');
...
customElements.define(componentSelector, IconNachosLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconNachosLarge;
    }
}
