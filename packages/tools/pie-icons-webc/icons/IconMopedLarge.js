...
export class IconMopedLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mopedLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mopedLarge', '', newVal, 'IconMopedLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mopedLarge', newVal);
    }
}
