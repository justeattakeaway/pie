...
const componentSelector = 'icon-cloud-large';

export class IconCloudLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cloudLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudLarge', '', this.size, 'IconCloudLarge');
...
customElements.define(componentSelector, IconCloudLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCloudLarge;
    }
}
