...
export class IconGlutenLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--glutenLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--glutenLarge', '', newVal, 'IconGlutenLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--glutenLarge', newVal);
    }
}
