...
export class IconPresentationChartLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--presentationChartLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--presentationChartLarge', '', newVal, 'IconPresentationChartLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--presentationChartLarge', newVal);
    }
}
