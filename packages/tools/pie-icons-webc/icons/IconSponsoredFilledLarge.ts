...
export class IconSponsoredFilledLarge extends LitElement implements IconProps {
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sponsoredFilledLarge', '', this.size, 'IconSponsoredFilledLarge');
...
customElements.define(componentSelector, IconSponsoredFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSponsoredFilledLarge;
    }
}
