...
const componentSelector = 'icon-toilet-large';

export class IconToiletLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--toiletLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--toiletLarge', '', this.size, 'IconToiletLarge');
...
customElements.define(componentSelector, IconToiletLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconToiletLarge;
    }
}
