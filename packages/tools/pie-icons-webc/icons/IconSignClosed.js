...
export class IconSignClosed extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--signClosed');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--signClosed', '', newVal, 'IconSignClosed');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--signClosed', newVal);
    }
}
