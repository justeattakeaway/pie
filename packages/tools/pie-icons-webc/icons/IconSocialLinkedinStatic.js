...
export class IconSocialLinkedinStatic extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinStatic');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinStatic', '', newVal, 'IconSocialLinkedinStatic');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinStatic', newVal);
    }
}
