...
const componentSelector = 'icon-payment-bitcoin';

export class IconPaymentBitcoin extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--bitcoin';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bitcoin', '', this.size, 'IconPaymentBitcoin');
...
customElements.define(componentSelector, IconPaymentBitcoin);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPaymentBitcoin;
    }
}
