...
export class IconStampcard10 extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stampcard10');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcard10', '', newVal, 'IconStampcard10');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--stampcard10', newVal);
    }
}

customElements.define('icon-stampcard10', IconStampcard10);
