...
export class IconUserMarker extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userMarker');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userMarker', '', newVal, 'IconUserMarker');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userMarker', newVal);
    }
}
