...
const componentSelector = 'icon-moped-large';

export class IconMopedLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--mopedLarge';
    ...
    connectedCallback () : void {
        if (this._svg?.getAttribute('width') === null) {
            const svgSize = getSvgProps('c-pieIcon c-pieIcon--mopedLarge', '', null, 'IconMopedLarge');
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mopedLarge', '', this.size, 'IconMopedLarge');
...
customElements.define(componentSelector, IconMopedLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMopedLarge;
    }
}
