...
const componentSelector = 'icon-user-repeat';

export class IconUserRepeat extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--userRepeat';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userRepeat', '', this.size, 'IconUserRepeat');
...
customElements.define(componentSelector, IconUserRepeat);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUserRepeat;
    }
}
