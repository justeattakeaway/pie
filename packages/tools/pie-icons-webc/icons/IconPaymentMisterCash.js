...
export class IconPaymentMisterCash extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--misterCash');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--misterCash', '', newVal, 'IconPaymentMisterCash');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--misterCash', newVal);
    }
}

customElements.define('icon-payment-mister-cash', IconPaymentMisterCash);
