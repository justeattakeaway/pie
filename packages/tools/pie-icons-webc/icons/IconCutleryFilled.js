...
export class IconCutleryFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutleryFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryFilled', '', newVal, 'IconCutleryFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutleryFilled', newVal);
    }
}
