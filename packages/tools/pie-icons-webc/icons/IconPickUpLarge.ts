...
const componentSelector = 'icon-pick-up-large';

export class IconPickUpLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--pickUpLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pickUpLarge', '', this.size, 'IconPickUpLarge');
...
customElements.define(componentSelector, IconPickUpLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPickUpLarge;
    }
}
