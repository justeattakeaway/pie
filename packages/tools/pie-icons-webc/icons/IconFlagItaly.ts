...
const componentSelector = 'icon-flag-italy';

export class IconFlagItaly extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--italy';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--italy', '', this.size, 'IconFlagItaly');
...
customElements.define(componentSelector, IconFlagItaly);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFlagItaly;
    }
}
