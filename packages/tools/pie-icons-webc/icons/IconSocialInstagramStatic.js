...
export class IconSocialInstagramStatic extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--instagramStatic', '', null, 'IconSocialInstagramStatic');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--instagramStatic');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--instagramStatic', '', newVal, 'IconSocialInstagramStatic');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--instagramStatic', newVal);
    }
}
