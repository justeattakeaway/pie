...
const componentSelector = 'icon-hi-vis-large';

export class IconHiVisLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--hiVisLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--hiVisLarge', '', this.size, 'IconHiVisLarge');
...
customElements.define(componentSelector, IconHiVisLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHiVisLarge;
    }
}
