...
export class IconSocialMicrosoftCircleFilledStaticLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--microsoftCircleFilledStaticLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--microsoftCircleFilledStaticLarge', '', newVal, 'IconSocialMicrosoftCircleFilledStaticLarge');
