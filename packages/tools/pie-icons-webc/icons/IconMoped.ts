...
const componentSelector = 'icon-moped';

export class IconMoped extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--moped';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--moped', '', this.size, 'IconMoped');
...
customElements.define(componentSelector, IconMoped);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMoped;
    }
}
