...
export class IconSwitchProduct extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--switchProduct');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--switchProduct', '', newVal, 'IconSwitchProduct');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--switchProduct', newVal);
    }
}
