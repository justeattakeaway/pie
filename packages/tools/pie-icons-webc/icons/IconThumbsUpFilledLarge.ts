...
const componentSelector = 'icon-thumbs-up-filled-large';

export class IconThumbsUpFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--thumbsUpFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsUpFilledLarge', '', this.size, 'IconThumbsUpFilledLarge');
...
customElements.define(componentSelector, IconThumbsUpFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconThumbsUpFilledLarge;
    }
}
