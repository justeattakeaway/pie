...
const componentSelector = 'icon-recycle-large';

export class IconRecycleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--recycleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--recycleLarge', '', this.size, 'IconRecycleLarge');
...
customElements.define(componentSelector, IconRecycleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRecycleLarge;
    }
}
