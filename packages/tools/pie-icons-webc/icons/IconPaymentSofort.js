...
export class IconPaymentSofort extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sofort');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--sofort', '', newVal, 'IconPaymentSofort');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--sofort', newVal);
    }
}

customElements.define('icon-payment-sofort', IconPaymentSofort);
