...
const componentSelector = 'icon-navigation-collapse-large';

export class IconNavigationCollapseLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--navigationCollapseLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--navigationCollapseLarge', '', this.size, 'IconNavigationCollapseLarge');
...
customElements.define(componentSelector, IconNavigationCollapseLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconNavigationCollapseLarge;
    }
}
