...
export class IconLev extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--lev');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--lev', '', newVal, 'IconLev');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--lev', newVal);
    }
}
