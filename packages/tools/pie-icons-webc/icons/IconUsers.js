...
export class IconUsers extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--users');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--users', '', newVal, 'IconUsers');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--users', newVal);
    }
}
