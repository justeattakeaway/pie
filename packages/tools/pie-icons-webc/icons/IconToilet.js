...
export class IconToilet extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--toilet');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--toilet', '', newVal, 'IconToilet');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--toilet', newVal);
    }
}
