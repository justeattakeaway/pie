...
export class IconPlayCircle extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--playCircle', '', null, 'IconPlayCircle');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--playCircle');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--playCircle', '', newVal, 'IconPlayCircle');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--playCircle', newVal);
    }
}

customElements.define('icon-play-circle', IconPlayCircle);
