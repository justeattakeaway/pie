...
export default class IconCheckboxSelected extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconCheckboxSelected');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconCheckboxSelected');
