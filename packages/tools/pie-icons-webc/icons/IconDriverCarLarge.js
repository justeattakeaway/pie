...
export class IconDriverCarLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--driverCarLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--driverCarLarge', '', newVal, 'IconDriverCarLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--driverCarLarge', newVal);
    }
}
