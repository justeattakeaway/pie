...
const componentSelector = 'icon-world-large';

export class IconWorldLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--worldLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--worldLarge', '', this.size, 'IconWorldLarge');
...
customElements.define(componentSelector, IconWorldLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconWorldLarge;
    }
}
