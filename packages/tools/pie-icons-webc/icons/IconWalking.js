...
export class IconWalking extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--walking');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--walking', '', newVal, 'IconWalking');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--walking', newVal);
    }
}
