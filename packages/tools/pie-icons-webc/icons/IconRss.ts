...
const componentSelector = 'icon-rss';

export class IconRss extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--rss';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--rss', '', this.size, 'IconRss');
...
customElements.define(componentSelector, IconRss);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRss;
    }
}
