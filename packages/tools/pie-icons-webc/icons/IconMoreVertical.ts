...
const componentSelector = 'icon-more-vertical';

export class IconMoreVertical extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--moreVertical';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--moreVertical', '', this.size, 'IconMoreVertical');
...
customElements.define(componentSelector, IconMoreVertical);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMoreVertical;
    }
}
