...
export class IconPetSuppliesLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--petSuppliesLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--petSuppliesLarge', '', newVal, 'IconPetSuppliesLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--petSuppliesLarge', newVal);
    }
}
