...
const componentSelector = 'icon-social-apple-circle';

export class IconSocialAppleCircle extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appleCircle';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleCircle', '', this.size, 'IconSocialAppleCircle');
...
customElements.define(componentSelector, IconSocialAppleCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAppleCircle;
    }
}
