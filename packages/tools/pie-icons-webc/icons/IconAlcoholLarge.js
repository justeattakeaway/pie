...
export class IconAlcoholLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alcoholLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--alcoholLarge', '', newVal, 'IconAlcoholLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alcoholLarge', newVal);
    }
}

customElements.define('icon-alcohol-large', IconAlcoholLarge);
