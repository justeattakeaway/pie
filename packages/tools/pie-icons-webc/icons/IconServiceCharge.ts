...
const componentSelector = 'icon-service-charge';

export class IconServiceCharge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--serviceCharge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--serviceCharge', '', this.size, 'IconServiceCharge');
...
customElements.define(componentSelector, IconServiceCharge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconServiceCharge;
    }
}
