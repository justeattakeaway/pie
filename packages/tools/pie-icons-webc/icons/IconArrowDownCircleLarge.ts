...
const componentSelector = 'icon-arrow-down-circle-large';

export class IconArrowDownCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--arrowDownCircleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--arrowDownCircleLarge', '', this.size, 'IconArrowDownCircleLarge');
...
customElements.define(componentSelector, IconArrowDownCircleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconArrowDownCircleLarge;
    }
}
