...
export class IconFlagUnitedKingdom extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--unitedKingdom');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--unitedKingdom', '', newVal, 'IconFlagUnitedKingdom');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--unitedKingdom', newVal);
    }
}
