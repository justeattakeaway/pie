...
export class IconHelpCircle extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--helpCircle');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--helpCircle', '', newVal, 'IconHelpCircle');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--helpCircle', newVal);
    }
}

customElements.define('icon-help-circle', IconHelpCircle);
