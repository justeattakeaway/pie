...
const componentSelector = 'icon-list';

export class IconList extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--list';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--list', '', this.size, 'IconList');
...
customElements.define(componentSelector, IconList);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconList;
    }
}
