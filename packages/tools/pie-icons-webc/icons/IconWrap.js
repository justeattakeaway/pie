...
export class IconWrap extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wrap');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--wrap', '', newVal, 'IconWrap');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--wrap', newVal);
    }
}

customElements.define('icon-wrap', IconWrap);
