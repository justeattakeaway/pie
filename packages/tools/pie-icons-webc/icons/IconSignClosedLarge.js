...
export class IconSignClosedLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--signClosedLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--signClosedLarge', '', newVal, 'IconSignClosedLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--signClosedLarge', newVal);
    }
}
