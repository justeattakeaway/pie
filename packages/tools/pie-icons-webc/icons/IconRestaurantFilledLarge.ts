...
const componentSelector = 'icon-restaurant-filled-large';

export class IconRestaurantFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--restaurantFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--restaurantFilledLarge', '', this.size, 'IconRestaurantFilledLarge');
...
customElements.define(componentSelector, IconRestaurantFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconRestaurantFilledLarge;
    }
}
