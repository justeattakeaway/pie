...
const componentSelector = 'icon-stampcard10-filled-large';

export class IconStampcard10FilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcard10FilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcard10FilledLarge', '', this.size, 'IconStampcard10FilledLarge');
...
customElements.define(componentSelector, IconStampcard10FilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcard10FilledLarge;
    }
}
