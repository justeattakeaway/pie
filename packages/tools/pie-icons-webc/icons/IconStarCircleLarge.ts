...
const componentSelector = 'icon-star-circle-large';

export class IconStarCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--starCircleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--starCircleLarge', '', this.size, 'IconStarCircleLarge');
...
customElements.define(componentSelector, IconStarCircleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStarCircleLarge;
    }
}
