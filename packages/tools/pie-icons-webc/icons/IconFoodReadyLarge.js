...
export class IconFoodReadyLarge extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--foodReadyLarge', newVal);
    }
}
