...
export class IconAppRestaurant extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--appRestaurant', '', null, 'IconAppRestaurant');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appRestaurant');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appRestaurant', '', newVal, 'IconAppRestaurant');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appRestaurant', newVal);
    }
}
