...
export class IconPrepare extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--prepare');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--prepare', '', newVal, 'IconPrepare');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--prepare', newVal);
    }
}

customElements.define('icon-prepare', IconPrepare);
