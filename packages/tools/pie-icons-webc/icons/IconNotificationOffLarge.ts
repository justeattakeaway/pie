...
const componentSelector = 'icon-notification-off-large';

export class IconNotificationOffLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--notificationOffLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--notificationOffLarge', '', this.size, 'IconNotificationOffLarge');
...
customElements.define(componentSelector, IconNotificationOffLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconNotificationOffLarge;
    }
}
