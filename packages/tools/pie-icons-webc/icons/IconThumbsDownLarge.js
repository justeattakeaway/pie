...
export class IconThumbsDownLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDownLarge', '', null, 'IconThumbsDownLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDownLarge', '', newVal, 'IconThumbsDownLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDownLarge', newVal);
    }
}
