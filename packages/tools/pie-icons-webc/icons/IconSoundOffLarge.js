...
export class IconSoundOffLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOffLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--soundOffLarge', '', newVal, 'IconSoundOffLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOffLarge', newVal);
    }
}
