...
export class IconPetSupplies extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--petSupplies', '', null, 'IconPetSupplies');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--petSupplies');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--petSupplies', '', newVal, 'IconPetSupplies');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--petSupplies', newVal);
    }
}
