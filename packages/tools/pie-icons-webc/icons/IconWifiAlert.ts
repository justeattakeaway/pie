...
const componentSelector = 'icon-wifi-alert';

export class IconWifiAlert extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--wifiAlert';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--wifiAlert', '', this.size, 'IconWifiAlert');
...
customElements.define(componentSelector, IconWifiAlert);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconWifiAlert;
    }
}
