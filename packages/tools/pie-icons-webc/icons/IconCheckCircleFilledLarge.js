...
export class IconCheckCircleFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--checkCircleFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--checkCircleFilledLarge', '', newVal, 'IconCheckCircleFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--checkCircleFilledLarge', newVal);
    }
}
