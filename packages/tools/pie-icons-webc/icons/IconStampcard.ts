...
const componentSelector = 'icon-stampcard';

export class IconStampcard extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--stampcard';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--stampcard', '', this.size, 'IconStampcard');
...
customElements.define(componentSelector, IconStampcard);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconStampcard;
    }
}
