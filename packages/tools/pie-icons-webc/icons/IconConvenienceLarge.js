...
export class IconConvenienceLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--convenienceLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--convenienceLarge', '', newVal, 'IconConvenienceLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--convenienceLarge', newVal);
    }
}
