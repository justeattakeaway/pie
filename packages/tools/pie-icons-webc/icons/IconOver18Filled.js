...
export class IconOver18Filled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--over18Filled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--over18Filled', '', newVal, 'IconOver18Filled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--over18Filled', newVal);
    }
}
