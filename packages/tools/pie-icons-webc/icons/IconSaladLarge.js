...
export class IconSaladLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--saladLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--saladLarge', '', newVal, 'IconSaladLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--saladLarge', newVal);
    }
}
