...
const componentSelector = 'icon-user-shield-large';

export class IconUserShieldLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--userShieldLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userShieldLarge', '', this.size, 'IconUserShieldLarge');
...
customElements.define(componentSelector, IconUserShieldLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUserShieldLarge;
    }
}
