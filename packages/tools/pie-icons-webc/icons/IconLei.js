...
export class IconLei extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--lei');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--lei', '', newVal, 'IconLei');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--lei', newVal);
    }
}
