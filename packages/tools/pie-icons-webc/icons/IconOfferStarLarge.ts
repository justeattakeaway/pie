...
const componentSelector = 'icon-offer-star-large';

export class IconOfferStarLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--offerStarLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--offerStarLarge', '', this.size, 'IconOfferStarLarge');
...
customElements.define(componentSelector, IconOfferStarLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconOfferStarLarge;
    }
}
