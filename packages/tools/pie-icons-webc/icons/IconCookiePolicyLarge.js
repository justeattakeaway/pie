...
export class IconCookiePolicyLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cookiePolicyLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cookiePolicyLarge', '', newVal, 'IconCookiePolicyLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cookiePolicyLarge', newVal);
    }
}
