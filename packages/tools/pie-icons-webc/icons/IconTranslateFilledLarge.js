...
export class IconTranslateFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--translateFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--translateFilledLarge', '', newVal, 'IconTranslateFilledLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--translateFilledLarge', newVal);
    }
}
