...
const componentSelector = 'icon-settings-large';

export class IconSettingsLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--settingsLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--settingsLarge', '', this.size, 'IconSettingsLarge');
...
customElements.define(componentSelector, IconSettingsLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSettingsLarge;
    }
}
