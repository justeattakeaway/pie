...
export class IconThumbsUp extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsUp');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsUp', '', newVal, 'IconThumbsUp');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsUp', newVal);
    }
}
