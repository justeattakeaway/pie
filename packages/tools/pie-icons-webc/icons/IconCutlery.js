...
export class IconCutlery extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutlery');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutlery', '', newVal, 'IconCutlery');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cutlery', newVal);
    }
}
