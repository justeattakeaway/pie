...
export class IconKebab extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kebab');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--kebab', '', newVal, 'IconKebab');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kebab', newVal);
    }
}
