...
export class IconSocialLinkedinCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--linkedinCircleLarge', '', newVal, 'IconSocialLinkedinCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinCircleLarge', newVal);
    }
}
