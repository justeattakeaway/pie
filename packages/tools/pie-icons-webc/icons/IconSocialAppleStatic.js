...
export class IconSocialAppleStatic extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--appleStatic', '', null, 'IconSocialAppleStatic');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleStatic');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appleStatic', '', newVal, 'IconSocialAppleStatic');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--appleStatic', newVal);
    }
}
