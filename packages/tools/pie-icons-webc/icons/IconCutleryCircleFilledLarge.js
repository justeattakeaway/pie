...
export class IconCutleryCircleFilledLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('c-pieIcon c-pieIcon--cutleryCircleFilledLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        const svg = this.root.querySelector('svg');
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryCircleFilledLarge', '', newVal, 'IconCutleryCircleFilledLarge');
