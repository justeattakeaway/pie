...
export class IconHeartFilledLarge extends LitElement implements IconProps {
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--heartFilledLarge', '', this.size, 'IconHeartFilledLarge');
...
customElements.define(componentSelector, IconHeartFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHeartFilledLarge;
    }
}
