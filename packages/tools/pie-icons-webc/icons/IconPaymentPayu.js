...
export class IconPaymentPayu extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--payu', '', null, 'IconPaymentPayu');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--payu');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--payu', '', newVal, 'IconPaymentPayu');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--payu', newVal);
    }
}
