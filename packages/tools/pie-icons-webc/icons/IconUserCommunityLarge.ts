...
const componentSelector = 'icon-user-community-large';

export class IconUserCommunityLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--userCommunityLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userCommunityLarge', '', this.size, 'IconUserCommunityLarge');
...
customElements.define(componentSelector, IconUserCommunityLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconUserCommunityLarge;
    }
}
