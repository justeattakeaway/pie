...
export class IconMealVoucher extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mealVoucher');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--mealVoucher', '', newVal, 'IconMealVoucher');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--mealVoucher', newVal);
    }
}
