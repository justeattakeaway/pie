...
export class IconThumbsDown extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDown');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--thumbsDown', '', newVal, 'IconThumbsDown');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--thumbsDown', newVal);
    }
}
