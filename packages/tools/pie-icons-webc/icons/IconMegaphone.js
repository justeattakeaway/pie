...
export class IconMegaphone extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--megaphone');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--megaphone', '', newVal, 'IconMegaphone');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--megaphone', newVal);
    }
}
