...
export class IconFlagNewZealand extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--newZealand');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--newZealand', '', newVal, 'IconFlagNewZealand');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--newZealand', newVal);
    }
}
