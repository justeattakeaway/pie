...
export class IconFlagUnitedStates extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--unitedStates');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--unitedStates', '', newVal, 'IconFlagUnitedStates');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--unitedStates', newVal);
    }
}

customElements.define('icon-flag-united-states', IconFlagUnitedStates);
