...
const componentSelector = 'icon-noodles';

export class IconNoodles extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--noodles';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--noodles', '', this.size, 'IconNoodles');
...
customElements.define(componentSelector, IconNoodles);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconNoodles;
    }
}
