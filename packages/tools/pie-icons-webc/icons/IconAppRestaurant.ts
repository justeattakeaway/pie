...
const componentSelector = 'icon-app-restaurant';

export class IconAppRestaurant extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--appRestaurant';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--appRestaurant', '', this.size, 'IconAppRestaurant');
...
customElements.define(componentSelector, IconAppRestaurant);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAppRestaurant;
    }
}
