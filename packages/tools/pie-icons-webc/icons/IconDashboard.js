...
export class IconDashboard extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--dashboard');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--dashboard', '', newVal, 'IconDashboard');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--dashboard', newVal);
    }
}
