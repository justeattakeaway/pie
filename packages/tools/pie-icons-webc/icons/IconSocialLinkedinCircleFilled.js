...
export class IconSocialLinkedinCircleFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--linkedinCircleFilled', newVal);
    }
}
