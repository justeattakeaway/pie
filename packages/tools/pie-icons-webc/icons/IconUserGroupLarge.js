...
export class IconUserGroupLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userGroupLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--userGroupLarge', '', newVal, 'IconUserGroupLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--userGroupLarge', newVal);
    }
}
