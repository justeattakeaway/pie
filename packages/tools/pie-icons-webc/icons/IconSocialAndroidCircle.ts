...
const componentSelector = 'icon-social-android-circle';

export class IconSocialAndroidCircle extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--androidCircle';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--androidCircle', '', this.size, 'IconSocialAndroidCircle');
...
customElements.define(componentSelector, IconSocialAndroidCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconSocialAndroidCircle;
    }
}
