...
export class IconCloudUpload extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloudUpload');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloudUpload', '', newVal, 'IconCloudUpload');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloudUpload', newVal);
    }
}
