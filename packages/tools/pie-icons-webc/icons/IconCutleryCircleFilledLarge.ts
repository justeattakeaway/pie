...
const componentSelector = 'icon-cutlery-circle-filled-large';

export class IconCutleryCircleFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cutleryCircleFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cutleryCircleFilledLarge', '', this.size, 'IconCutleryCircleFilledLarge');
...
customElements.define(componentSelector, IconCutleryCircleFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCutleryCircleFilledLarge;
    }
}
