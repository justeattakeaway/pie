...
const componentSelector = 'icon-hand-heart-large';

export class IconHandHeartLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--handHeartLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--handHeartLarge', '', this.size, 'IconHandHeartLarge');
...
customElements.define(componentSelector, IconHandHeartLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHandHeartLarge;
    }
}
