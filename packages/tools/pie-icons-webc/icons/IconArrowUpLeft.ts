...
export class IconArrowUpLeft extends LitElement implements IconProps {
    ...
    @property({ type: String, reflect: true })
    public class = 'c-pieIcon c-pieIcon--arrowUpLeft';
    ...
    render () : TemplateResult {
        return html`<svg xmlns="http://www.w3.org/2000/svg" role="presentation" focusable="false" fill="currentColor" viewBox="0 0 16 16" class="c-pieIcon c-pieIcon--arrowUpLeft"><path d="m12.795 11.867-7.21-7.21h4.655V3.345H4.439a1.094 1.094 0 0 0-1.094 1.094v5.801h1.313V5.585l7.21 7.21.927-.928Z"></path></svg>`;
    }
}
