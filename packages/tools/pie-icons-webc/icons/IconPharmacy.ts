...
const componentSelector = 'icon-pharmacy';

export class IconPharmacy extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--pharmacy';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pharmacy', '', this.size, 'IconPharmacy');
...
customElements.define(componentSelector, IconPharmacy);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPharmacy;
    }
}
