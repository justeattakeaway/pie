...
export class IconPlayCircle extends LitElement implements IconProps {
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--playCircle', '', this.size, 'IconPlayCircle');
...
customElements.define(componentSelector, IconPlayCircle);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPlayCircle;
    }
}
