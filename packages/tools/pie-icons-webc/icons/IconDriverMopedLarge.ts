...
const componentSelector = 'icon-driver-moped-large';

export class IconDriverMopedLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--driverMopedLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--driverMopedLarge', '', this.size, 'IconDriverMopedLarge');
...
customElements.define(componentSelector, IconDriverMopedLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconDriverMopedLarge;
    }
}
