...
export class IconAlertCircleLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alertCircleLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--alertCircleLarge', '', newVal, 'IconAlertCircleLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--alertCircleLarge', newVal);
    }
}
