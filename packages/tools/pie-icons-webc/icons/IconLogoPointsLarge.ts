...
const componentSelector = 'icon-logo-points-large';

export class IconLogoPointsLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--pointsLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pointsLarge', '', this.size, 'IconLogoPointsLarge');
...
customElements.define(componentSelector, IconLogoPointsLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLogoPointsLarge;
    }
}
