...
export class IconChatHeartLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--chatHeartLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--chatHeartLarge', '', newVal, 'IconChatHeartLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--chatHeartLarge', newVal);
    }
}
