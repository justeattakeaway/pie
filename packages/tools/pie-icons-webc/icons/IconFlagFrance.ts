...
const componentSelector = 'icon-flag-france';

export class IconFlagFrance extends LitElement implements IconProps {
    static styles = css`
    ...
    @property({ type: String, reflect: true })
    public class = 'c-pieIcon c-pieIcon--france';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--france', '', this.size, 'IconFlagFrance');
...
customElements.define(componentSelector, IconFlagFrance);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconFlagFrance;
    }
}
