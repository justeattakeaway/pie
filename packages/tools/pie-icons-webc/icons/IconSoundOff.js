...
export class IconSoundOff extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOff');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--soundOff', '', newVal, 'IconSoundOff');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--soundOff', newVal);
    }
}
