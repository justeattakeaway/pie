...
const componentSelector = 'icon-molluscs';

export class IconMolluscs extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--molluscs';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--molluscs', '', this.size, 'IconMolluscs');
...
customElements.define(componentSelector, IconMolluscs);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconMolluscs;
    }
}
