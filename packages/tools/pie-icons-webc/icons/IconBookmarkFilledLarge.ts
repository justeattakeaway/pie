...
const componentSelector = 'icon-bookmark-filled-large';

export class IconBookmarkFilledLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--bookmarkFilledLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bookmarkFilledLarge', '', this.size, 'IconBookmarkFilledLarge');
...
customElements.define(componentSelector, IconBookmarkFilledLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconBookmarkFilledLarge;
    }
}
