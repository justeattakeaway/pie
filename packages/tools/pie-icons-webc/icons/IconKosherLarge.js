...
export class IconKosherLarge extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--kosherLarge', '', null, 'IconKosherLarge');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kosherLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--kosherLarge', '', newVal, 'IconKosherLarge');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--kosherLarge', newVal);
    }
}
