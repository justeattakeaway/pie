...
const componentSelector = 'icon-helmet';

export class IconHelmet extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--helmet';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--helmet', '', this.size, 'IconHelmet');
...
customElements.define(componentSelector, IconHelmet);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconHelmet;
    }
}
