...
export class IconPharmacy extends HTMLElement {
    ...
    connectedCallback () {
        ...
        const svgSize = getSvgProps('c-pieIcon c-pieIcon--pharmacy', '', null, 'IconPharmacy');
        svg.setAttribute('width', svgSize.width);
        svg.setAttribute('height', svgSize.height);
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pharmacy');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pharmacy', '', newVal, 'IconPharmacy');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pharmacy', newVal);
    }
}
