...
export class IconGeolocationCircleFilled extends HTMLElement {
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--geolocationCircleFilled', newVal);
    }
}
