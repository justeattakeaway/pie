...
export class IconSocialBloggerCircleFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bloggerCircleFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--bloggerCircleFilled', '', newVal, 'IconSocialBloggerCircleFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--bloggerCircleFilled', newVal);
    }
}
