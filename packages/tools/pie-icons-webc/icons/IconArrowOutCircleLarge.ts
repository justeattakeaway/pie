...
const componentSelector = 'icon-arrow-out-circle-large';

export class IconArrowOutCircleLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--arrowOutCircleLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--arrowOutCircleLarge', '', this.size, 'IconArrowOutCircleLarge');
...
customElements.define(componentSelector, IconArrowOutCircleLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconArrowOutCircleLarge;
    }
}
