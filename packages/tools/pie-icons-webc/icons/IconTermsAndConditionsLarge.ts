...
const componentSelector = 'icon-terms-and-conditions-large';

export class IconTermsAndConditionsLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--termsAndConditionsLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--termsAndConditionsLarge', '', this.size, 'IconTermsAndConditionsLarge');
...
customElements.define(componentSelector, IconTermsAndConditionsLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconTermsAndConditionsLarge;
    }
}
