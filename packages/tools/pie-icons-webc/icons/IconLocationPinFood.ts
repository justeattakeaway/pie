...
const componentSelector = 'icon-location-pin-food';

export class IconLocationPinFood extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--locationPinFood';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--locationPinFood', '', this.size, 'IconLocationPinFood');
...
customElements.define(componentSelector, IconLocationPinFood);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconLocationPinFood;
    }
}
