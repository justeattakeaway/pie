...
const componentSelector = 'icon-credit-card-filled';

export class IconCreditCardFilled extends LitElement implements IconProps {
    static styles = css`
    ...
    @property({ type: String, reflect: true })
    public class = 'c-pieIcon c-pieIcon--creditCardFilled';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--creditCardFilled', '', this.size, 'IconCreditCardFilled');
...
customElements.define(componentSelector, IconCreditCardFilled);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCreditCardFilled;
    }
}
