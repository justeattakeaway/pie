...
export class IconCloud extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloud');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cloud', '', newVal, 'IconCloud');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--cloud', newVal);
    }
}
