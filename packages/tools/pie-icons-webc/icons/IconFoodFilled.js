...
export class IconFoodFilled extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--foodFilled');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--foodFilled', '', newVal, 'IconFoodFilled');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--foodFilled', newVal);
    }
}
