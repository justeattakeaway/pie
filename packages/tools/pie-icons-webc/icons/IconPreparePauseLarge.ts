...
const componentSelector = 'icon-prepare-pause-large';

export class IconPreparePauseLarge extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--preparePauseLarge';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--preparePauseLarge', '', this.size, 'IconPreparePauseLarge');
...
customElements.define(componentSelector, IconPreparePauseLarge);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconPreparePauseLarge;
    }
}
