...
export default class IconRestrictedLarge extends HTMLElement {
    constructor () {
        super();
    ...
    connectedCallback () {
        ...
        const defaultSize = getDefaultIconSize('IconRestrictedLarge');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        const svgSize = getSvgProps('', '', newVal, 'IconRestrictedLarge');
...
customElements.define('icon-restricted-large', IconRestrictedLarge);
