...
const componentSelector = 'icon-alcohol';

export class IconAlcohol extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--alcohol';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--alcohol', '', this.size, 'IconAlcohol');
...
customElements.define(componentSelector, IconAlcohol);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconAlcohol;
    }
}
