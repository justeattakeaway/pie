...
export class IconPizza extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pizza');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--pizza', '', newVal, 'IconPizza');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--pizza', newVal);
    }
}
