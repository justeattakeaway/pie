...
const componentSelector = 'icon-cash';

export class IconCash extends LitElement implements IconProps {
    @property({ type: String, reflect: true })
    public size : Size = 'medium';

    @property({ type: String, reflect: true })
    public class : string = 'c-pieIcon c-pieIcon--cash';
    ...
    updated (changedProperties: DependentMap<IconProps>) : void {
        ...
        if (changedProperties.has('size')) {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--cash', '', this.size, 'IconCash');
...
customElements.define(componentSelector, IconCash);

declare global {
    interface HTMLElementTagNameMap {
        [componentSelector]: IconCash;
    }
}
