...
export class IconLaptopError extends HTMLElement {
    ...
    connectedCallback () {
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--laptopError');
    ...
    attributeChangedCallback (attr, oldVal, newVal) {
        ...
        console.log(attr);
        if (attr === 'size') {
            svgSize = getSvgProps('c-pieIcon c-pieIcon--laptopError', '', newVal, 'IconLaptopError');
        ...
        this.setAttribute('class', 'c-pieIcon c-pieIcon--laptopError', newVal);
    }
}
