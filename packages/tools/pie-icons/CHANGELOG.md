...
- Updated dependencies []:
  - @justeattakeaway/pie-monorepo-utils@0.9.10
...
- [Fixed] automation issue happening when icon files were only updated, not added ([#2654](https://github.com/justeattakeaway/pie/pull/2654)) by [@fernandofranca](https://github.com/fernandofranca)
...
- [Changed] - icons were undated to follow unified optimised format. The update doesn't change icons visually. ([#823](https://github.com/justeattakeaway/pie/pull/823)) by [@dandel10n](https://github.com/dandel10n)
...
- [Added] - new icons (large and small variants) ([#797](https://github.com/justeattakeaway/pie/pull/797)) by [@xander-marjoram](https://github.com/xander-marjoram)
