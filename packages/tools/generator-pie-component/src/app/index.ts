...
export default class extends Generator {
    ...
    async writing () {
        ...
        const processDestinationPath = (filePath: string) => filePath.replace(/\b(pie-component)\b/g, `pie-${fileName}`).replace(/__/g, '');
        ...
        this.fs.copyTpl(
            ...
            undefined,
            {
                globOptions: { dot: true, ignore: ['**/pie-component.__stories__.ts'] },
                processDestinationPath,
            },
        );

        this.fs.copyTpl(
            this.templatePath('**/pie-component.__stories__.ts'),
