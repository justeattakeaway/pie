...
- [Fixed] - Component generation broken after `yeoman-generator` was upgraded from v5 to v8. ([#2951](https://github.com/justeattakeaway/pie/pull/2951)) by [@jamieomaguire](https://github.com/jamieomaguire)
