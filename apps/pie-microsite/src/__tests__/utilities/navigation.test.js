...
describe('PIE Microsite - Navigation', () => {
    it('should compare the actual navigation routes to the JSON snapshot.', () => {
        ...
        expect(routes, 'If you believe this route is expected, please run yarn test:generate-routes to regenerate the expected routes snapshot.').toEqual(expectedRoutes);
    });
});
