...
We don’t recommend using text with opacity as it can comprise accessibility and user experience. Learn more about the options available [in the Colours documentation](/foundations/colour).
