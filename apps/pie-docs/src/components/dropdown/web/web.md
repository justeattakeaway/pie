...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/anatomy.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/anatomy-2.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/variants-default.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/variants-search.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-expanded.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-content.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-multiselect.svg",
    alt: "A dropdown component showing the multi-select modifier with a chip indicating the number of selected items.",
    width: "200"
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-label.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-assistive-text.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-form-labels.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-popover-multiselect.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-popover-scrollable.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-popover-loading.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-option-multiselect.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/modifiers-option-selected.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/sizes-small.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/sizes-medium.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/sizes-large.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/interactive-states-option-default.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/interactive-states-option-hover.svg",
    alt: "A dropdown option in its hover state, with a background highlight indicating the cursor is over it.",
    width: "200"
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/interactive-states-option-active.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/interactive-states-option-focus.svg",
    alt: "A dropdown option in its focus state, showing a focus ring around the option.",
    width: "200"
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/behaviour-expand.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/behaviour-selection.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/behaviour-search.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/dropdown/example-rtl.svg",
