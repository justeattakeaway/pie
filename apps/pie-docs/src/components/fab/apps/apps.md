...
{% contentPageImage {
    src:"../../../assets/img/components/fab/apps/anatomy.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/variations-compact.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/variations-extended.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-primary-icon.svg",
      width: "200",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-primary-icon-label.svg",
      width: "200",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-inverse-icon.svg",
      width: "200",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-inverse-icon-label.svg",
      width: "200",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-inverse-secondary-icon.svg",
      width: "200",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/modifiers-inverse-secondary-icon-label.svg",
      width: "200",
...
{% contentLayout %}
  {% contentItem %}
    <h4>Large</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-compact-large.svg",
      width: "200",
  ...
  {% contentItem %}
    <h4>Medium</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-compact-medium.svg",
      width: "200",
...
{% endcontentItem %}
    ...
    <h4>Small</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-compact-small.svg",
      width: "200",
  ...
  {% contentItem %}
    <h4>XSmall</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-compact-xsmall.svg",
      width: "200",
...
{% contentLayout %}
  {% contentItem %}
    <h4>Large</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-extended-large.svg",
      width: "200",
      alt: "A large compact FAB button"
    } %}
  {% endcontentItem %}
  {% contentItem %}
    <h4>Medium</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-extended-medium.svg",
      width: "200",
      alt: "A medium compact FAB button"
    } %}
  {% endcontentItem %}
    ...
    <h4>Small</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-extended-small.svg",
      width: "200",
      alt: "A small compact FAB button"
    } %}
  {% endcontentItem %}
  {% contentItem %}
    <h4>XSmall</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/sizes-extended-xsmall.svg",
      width: "200",
      alt: "A extra small compact FAB button"
    } %}
  {% endcontentItem %}
...
{% contentPageImage {
    src:"../../../assets/img/components/fab/apps/overflow-single-word.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/overflow-multiple-words.svg",
...
{% contentPageImage {
    src: "../../../assets/img/components/fab/apps/position-ltr.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/position-rtl.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/hierarchy.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/fab/apps/behaviours-scrolling.svg",
...
{% contentLayout %}
  {% contentItem %}
    <h4>Default</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/interactive-states-default.svg",
      width: "300",
  ...
  {% contentItem %}
    <h4>Active</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/interactive-states-active.svg",
      width: "300",
  ...
  {% contentItem %}
    <h4>Loading</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/interactive-states-loading.svg",
      width: "300",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/examples-ltr-example-label.svg",
      width: "200",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/examples-ltr-example-icon.svg",
      width: "200",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/fab/apps/examples-rtl-example-label.svg",
      width: "200",
