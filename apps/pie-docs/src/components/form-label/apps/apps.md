...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/anatomy.svg",
...
{% contentLayout %}
  {% contentItem %}
    <h4>Label</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/variation-leading-label.svg",
      width: 34,
  ...
  {% contentItem %}
    ...
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-leading-tooltip-icon.svg",
  ...
  {% endcontentItem %}
    ...
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-leading-tooltip-icon-info.svg",
  ...
  {% contentItem %}
    <h4>Optional</h4>
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-leading-optional.svg",
  ...
  {% contentItem %}
    ...
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-leading-placeholder-icon.svg",
...
{% contentLayout %}
  {% contentItem %}
    ...
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-trailing-character-count.svg",
  ...
  {% contentItem %}
    <h4>Percentage</h4>
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-trailing-percentage.svg",
  ...
  {% contentItem %}
    <h4>Stepper</h4>
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-trailing-stepper.svg",
  ...
  {% contentItem %}
    <h4>String</h4>
    {% contentPageImage {
      src:"../../../assets/img/components/form-label/apps/variation-trailing-string.svg",
...
When a leading icon isn’t available within the form element, one may be available within the form label. This should be used with caution and only within standalone form elements.

{% notification {
  type: "information",
  message: "At the moment, we only support the leading placeholder icon for the Progress bar nested component."
} %}

{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-leading-placeholder-icon.svg",
    alt: "A leading form label with placeholder icon",
    width: 54
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-leading-help-icon.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-leading-info-icon.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-leading-optional.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-leading-multiline-label.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-trailing-character-count.svg",
    alt: "A form label with trailing character count",
    width: 30
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-trailing-stepper.svg",
    alt: "A form label with trailing stepper",
    width: 36
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-trailing-percentage.svg",
    alt: "A form label with trailing percentage",
    width: 256
} %}
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/modifiers-trailing-string.svg",
    alt: "A form label with trailing string",
    width: 256
} %}
...
{% usage {
    do: {
        ...
        items: [{
            src: "../../../assets/img/components/form-label/apps/content-label-do-1.svg",
            width: "256px",
    ...
    dont: {
        type: usageTypes.image,
        items: [{
            src: "../../../assets/img/components/form-label/apps/content-label-dont-1.svg",
            width: "256px",
...
{% usage {
    do: {
        ...
        variant: "secondary",
        items: [{
            src: "../../../assets/img/components/form-label/apps/content-label-do-2.svg",
            width: "288px",
            alt: "Examples of encouraged form label usage."
        }]
    },
    dont: {
        ...
        variant: "secondary",
        items: [{
            src: "../../../assets/img/components/form-label/apps/content-label-dont-2.svg",
            width: "288px",
            alt: "Examples of discouraged form label usage."
        }]
    }
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/content-string-do-1.svg",
      width: 308,
      variant: "secondary",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/content-string-do-2.svg",
      width: 288,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/content-character-count-stepper-percentage.svg",
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/content-overrides.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/behaviours-character-counter-1.svg",
      width: 256,
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/behaviours-character-counter-2.svg",
      width: 257,
...
{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/behaviours-stepper-percentage-string.svg",
...
A tooltip is triggered by tapping on the Help tooltip icon in the form label. A tooltip will close once the user hovers off the icon or taps outside of the icon.

The touch target area must be at least 24px by 24px to ensure accessibility.

{% contentPageImage {
    src:"../../../assets/img/components/form-label/apps/interactions-tooltip-icon.svg",
    alt: "A form label with help tooltip icon",
    width: 256
} %}
...
{% usage {
    do: {
        type: usageTypes.image,
        items: [{
            src: "../../../assets/img/components/form-label/apps/layout-position-do.svg",
            width: "280px",
            alt: "Example of encouraged form label usage."
        }]
    },
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-ltr-1.svg",
      width: 256,
      alt: "Example of encouraged form label usage."
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-ltr-2.svg",
      width: 326,
      alt: "Example of encouraged form label usage."
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-ltr-3.svg",
      width: 288,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-ltr-4.svg",
      width: 288,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-ltr-5.svg",
      width: 308,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-rtl-1.svg",
      width: 256,
      alt: "Example of encouraged form label usage."
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-rtl-2.svg",
      width: 326,
      alt: "Example of encouraged form label usage."
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-rtl-3.svg",
      width: 288,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/form-label/apps/examples-rtl-4.svg",
      width: 288,
      variant: "secondary",
      alt: "Example of encouraged form label usage."
    } %}
