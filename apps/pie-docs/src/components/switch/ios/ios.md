...
{% contentPageImage {
    src:"../../../assets/img/components/switch/ios/anatomy.svg",
...
{% contentLayout %}
  {% contentItem %}
    <h4>Left</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/modifiers-labels-left.svg",
      width: 97,
  ...
  {% contentItem %}
    <h4>Right</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/modifiers-labels-right.svg",
      width: 94,
...
{% contentLayout %}
  {% contentItem %}
    <h4>Selected</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/states-selected-ltr.svg",
      width: 200,
  ...
  {% contentItem %}
    <h4>Unselected</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/states-unselected-ltr.svg",
      width: 200,
...
{% contentLayout %}
  {% contentItem %}
    <h4>Selected</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/states-selected-rtl.svg",
      width: 200,
  ...
  {% contentItem %}
    <h4>Unselected</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/states-unselected-rtl.svg",
      width: 200,
...
{% contentLayout %}
  {% contentItem %}
    <h4>Default</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/interactive-states-default.svg",
      width: 200,
  ...
  {% contentItem %}
    <h4>Active</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/interactive-states-active.svg",
      width: 200,
  ...
  {% contentItem %}
    <h4>Disabled</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/interactive-states-disabled.svg",
      width: 200,
      variant: "secondary",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/examples-ltr-1.svg",
      width: 200,
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/examples-ltr-2.svg",
      width: 200,
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/examples-rtl-1.svg",
      width: 200,
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/switch/ios/examples-rtl-2.svg",
      width: 200,
