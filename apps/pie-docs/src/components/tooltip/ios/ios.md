...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/anatomy.svg",
alt: "Anatomy of the iOS tooltip component.",
width: 200
} %}
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/variants-default.svg",
alt: "Default variant of the iOS tooltip component.",
width: 200
} %}
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/variants-inverse-solid-bg.svg",
      width: 200,
      alt: "Inverse variant of the iOS tooltip component in an inverse solid background.",
      variant: "inverse"
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/variants-inverse-complex-bg.svg",
      alt: "Inverse variant of the iOS tooltip component in a complex background."
    } %}
  {% endcontentItem %}
{% endcontentLayout %}
...
{% contentLayout %}
  ...
  <h4>With title</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-title-with-title.svg",
      width: 200,
  ...
  <h4>Without title</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-title-without-title.svg",
      width: 200,
...
{% contentLayout %}
  ...
  <h4>With action</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-action-with-action.svg",
      width: 200,
  ...
  <h4>Without action</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-action-without-action.svg",
      width: 200,
...
{% contentLayout %}
  ...
  <h4>With close</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-close-icon-with-close.svg",
      width: 200,
  ...
  <h4>Without close</h4>
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/modifiers-close-icon-without-close.svg",
      width: 200,
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/sizes-width-predefined.svg",
alt: "Example of iOS tooltip component with the predefined width.",
width: 200
} %}
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/sizes-width-fluid-content.svg",
alt: "Example of iOS tooltip component with width fluid to content.",
width: 200
} %}
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/sizes-width-fluid-container.svg",
alt: "Example of iOS tooltip component with width fluid to container.",
width: 200
} %}
...
alt: "Example of iOS tooltip component showing 4px spacing between end of the pointer and element.",
width: 200
} %}
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/behaviours-trigger-left.svg",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/behaviours-trigger-left-top.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/behaviours-close-persistent-left.svg",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/behaviours-close-persistent-right.svg",
...
{% usage {
    do: {
        ...
        items: [{
            src: "../../../assets/img/components/tooltip/ios/behaviours-only-one-do.svg",
            width: 200,
    ...
    dont: {
        type: usageTypes.image,
        items: [{
            src: "../../../assets/img/components/tooltip/ios/behaviours-only-one-dont.svg",
            width: 200,
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/interactions-trigger.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/interaction-close-left.svg",
      alt: "Example of the tooltip with a close icon button.",
      width: 200
    } %}
  {% endcontentItem %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/interaction-close-right.svg",
      alt: "Example of the tooltip with a close icon and an action button.",
      width: 200
    } %}
  {% endcontentItem %}
...
{% contentPageImage {
src:"../../../assets/img/components/tooltip/ios/overflow.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/examples-ltr-left.svg",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/examples-ltr-right.svg",
      alt: "Example of the tooltip component in left-to-right context.",
      width: 200
    } %}
  {% endcontentItem %}
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/examples-rtl-left.svg",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/tooltip/ios/examples-rtl-right.svg",
      alt: "Example of the tooltip component in right-to-left context.",
      width: 200
    } %}
  {% endcontentItem %}
