...
{% contentPageImage {
src:"../../../assets/img/components/radio/ios/anatomy.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio/ios/variants-default.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio/ios/modifiers-no-label.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/alignment-vertical.svg",
      width: "90px",
...
{% contentPageImage {
src:"../../../assets/img/components/radio/ios/overflow.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/interactions-label-true.svg",
      width: "90px",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/interactions-label-false.svg",
      width: "30px",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/states-unselected.svg",
      width: "30px",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/states-selected.svg",
      width: "30px",
...
{% contentLayout %}
  ...
  <h3>Default</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/interactive-states-default.svg",
      width: "90px",
...
{% contentLayout %}
  ...
  <h3>Error</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/interactive-states-error.svg",
      width: "90px",
  ...
  <h3>Disabled</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/interactive-states-disabled.svg",
      width: "90px",
      variant: "secondary",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/examples-ltr-1.svg",
      width: "90px",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/examples-ltr-2.svg",
      width: "180px",
      variant: "secondary",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/examples-rtl-1.svg",
      width: "90px",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio/ios/examples-rtl-2.svg",
      width: "180px",
      variant: "secondary",
