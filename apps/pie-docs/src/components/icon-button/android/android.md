...
{% contentLayout %}
  ...
  {% contentItem %}
    <h3>Outline</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/variation-outline-apps.svg",
      width: 56,
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/hierarchy-low-outline-apps.svg",
      width: 56,
      alt: "Outline variant of an icon button."
    } %}
  {% endcontentItem %}
...
{% contentLayout %}
  {% contentItem %}
    <h3>Default</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/interactive-state-default-apps.svg",
      width: 48,
  ...
  {% contentItem %}
    <h3>Active</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/interactive-state-active-apps.svg",
      width: 48,
  ...
  {% contentItem %}
    <h3>Disabled</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/interactive-state-disabled-apps.svg",
      width: 48,
  ...
  {% contentItem %}
    <h3>Loading</h3>
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/interactive-state-loading-apps.svg",
      width: 48,
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/example-hamburger-menu-apps.svg",
      width: 48,
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/icon-button/example-close-apps.svg",
      width: 48,
