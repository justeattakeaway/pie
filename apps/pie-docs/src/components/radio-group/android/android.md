...
{% notification {
  type: "information",
  message: "**Design only.** The Radio Group is provided as a Figma component. In Android development, this pattern is built using native platform controls rather than a shared component."
} %}
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/anatomy.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/variants-horizontal.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/variants-vertical.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/modifiers-form-label.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/modifiers-assistive-text.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/overflow.svg",
...
{% contentLayout %}
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio-group/android/states-error.svg",
      width: "300px",
  ...
  {% contentItem %}
    {% contentPageImage {
      src: "../../../assets/img/components/radio-group/android/states-disabled.svg",
      width: "300px",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/examples-ltr.svg",
...
{% contentPageImage {
src:"../../../assets/img/components/radio-group/android/examples-rtl.svg",
