...
{% contentPageImage {
    src: "../../../assets/img/components/chip/overflow-expand-left.svg",
    alt: "A row of chips with horizontal scrolling enabled and a Chip overflow button pinned to the right.",
    width: 48
} %}
...
{% contentPageImage {
    src: "../../../assets/img/components/chip/overflow-expand-right.svg",
    alt: "A bottom sheet opened after tapping the Chip overflow button, displaying all chip options.",
    width: 48
} %}
