...
const createLargeTextContent = () => `Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quas inventore quasi ullam, sed ab odio dicta, tempore, ex adipisci atque asperiores suscipit quisquam alias aliquam minus amet ad a?
...
const CustomHeaderContentStoryTemplate = (props: ModalProps) => {
    const {
        aria,
        hasBackButton,
        heading,
