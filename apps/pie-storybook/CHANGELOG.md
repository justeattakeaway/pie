...
- [Changed] - `hoistingLimits` config to prevent issues with conflicting dependency versions ([#1020](https://github.com/justeattakeaway/pie/pull/1020)) by [@raoufswe](https://github.com/raoufswe)
