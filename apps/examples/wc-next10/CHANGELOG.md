...
- [Changed] - Webpack config & babel plugins to support Lit 3 as per the upgrade guide - https://lit.dev/docs/releases/upgrade/#using-lit-3-with-webpack-4 ([#1025](https://github.com/justeattakeaway/pie/pull/1025)) by [@raoufswe](https://github.com/raoufswe)
