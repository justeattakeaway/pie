...
- [Added] - `"ignoreDeprecations": "5.0"` property to tsconfig.json to prevent build errors. ([#602](https://github.com/justeattakeaway/pie/pull/602)) by [@siggerzz](https://github.com/siggerzz)
