import{B as tt,T as K,x as W}from"./lit-html-9a7df450.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const at=ot(class extends rt{constructor(i){var t;if(super(i),i.type!==nt.ATTRIBUTE||i.name!=="class"||((t=i.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){var e,s;if(this.it===void 0){this.it=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!(!((e=this.nt)===null||e===void 0)&&e.has(o))&&this.it.add(o);return this.render(t)}const n=i.element.classList;this.it.forEach(o=>{o in t||(n.remove(o),this.it.delete(o))});for(const o in t){const r=!!t[o];r===this.it.has(o)||!((s=this.nt)===null||s===void 0)&&s.has(o)||(r?(n.add(o),this.it.add(o)):(n.remove(o),this.it.delete(o)))}return K}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,T=(i,t)=>function(e,s){const n=`#${s}`;Object.defineProperty(e,s,{get(){return this[n]},set(o){const r=this[n];i.includes(o)?this[n]=o:(console.error(`[pie-button] Invalid value "${o}" provided for property "${s}".`,`Must be one of: ${i.join(" | ")}.`,`Falling back to default value: "${t}"`),this[n]=t),this.requestUpdate(s,r)}})};var l=(i=>(i.XSMALL="xsmall",i.SMALL="small",i.MEDIUM="medium",i.LARGE="large",i))(l||{}),d=(i=>(i.SUBMIT="submit",i.BUTTON="button",i.RESET="reset",i.MENU="menu",i))(d||{}),a=(i=>(i.PRIMARY="primary",i.SECONDARY="secondary",i.OUTLINE="outline",i.GHOST="ghost",i))(a||{}),ht=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,$=(i,t,e,s)=>{for(var n=s>1?void 0:s?pt(t,e):t,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(t,e,n):r(n))||n);return s&&n&&ht(t,e,n),n};function ut(i){return t=>{if(!customElements.get(i))return lt(i)(t)}}let c=class extends f{constructor(){super(...arguments),this.size=l.MEDIUM,this.type=d.SUBMIT,this.variant=a.PRIMARY,this.disabled=!1}render(){const{size:i,type:t,variant:e,disabled:s}=this,n={"o-btn":!0,[`o-btn--${i}`]:i,[`o-btn--${e}`]:e,"o-btn--is-disabled":s},o=()=>{const r=new CustomEvent("CustomEvent",{detail:"WC event dispatched"});console.info("WC event dispatched"),this.dispatchEvent(r)};return W`
    ...
    `,S={size:l.MEDIUM,type:d.SUBMIT,variant:a.PRIMARY,slot:"This is Lit!",disabled:!1},p=g.bind({});p.args={...S};const u=g.bind({});u.args={...S,variant:a.SECONDARY};const v=g.bind({});v.args={...S,variant:a.OUTLINE};const b=g.bind({});b.args={...S,variant:a.GHOST};var I,L,j;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`({
  size,
  variant,
  type,
  disabled,
  ...
  return html\`
    ...
    \`;
}`,...(B=(N=u.parameters)==null?void 0:N.docs)==null?void 0:B.source}}};var Y,H,G;v.parameters={...v.parameters,docs:{...(Y=v.parameters)==null?void 0:Y.docs,source:{originalSource:`({
  size,
  variant,
  type,
  disabled,
  ...
  return html\`
    ...
    \`;
}`,...(G=(H=v.parameters)==null?void 0:H.docs)==null?void 0:G.source}}};var V,q,J;b.parameters={...b.parameters,docs:{...(V=b.parameters)==null?void 0:V.docs,source:{originalSource:`({
  size,
  variant,
  type,
  disabled,
  ...
  return html\`
    ...
    \`;
}`,...(J=(q=b.parameters)==null?void 0:q.docs)==null?void 0:J.source}}};const mt=["Primary","Secondary","Outline","Ghost"];export{b as Ghost,v as Outline,p as Primary,u as Secondary,mt as __namedExportsOrder,yt as default};
//# sourceMappingURL=pie-button.stories-52d9acf6.js.map
