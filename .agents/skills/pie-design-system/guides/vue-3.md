...
## Dependencies
There are no vue-specific dependencies required. Please refer to the Getting started guide for the dependencies required to use PIE Web Components in your application.
