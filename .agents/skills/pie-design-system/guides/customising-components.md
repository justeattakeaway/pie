...
An example of this is our Tag component. As you can see, in the linked Story we fully customise how the component looks by writing our own CSS to be used in the `::part(body)` and `::part(icon)`.
